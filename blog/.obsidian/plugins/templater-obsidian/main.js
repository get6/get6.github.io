    ...
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let r of wa(e))
        !Ea.call(n, r) &&
          ...
          Rn(n, r, {
            get: () => e[r],
            enumerable: !(t = va(e, r)) || t.enumerable,
          })
    return n
  },
  X = (n) =>
      ...
      for (
        ...
        switch (d.kind) {
          case g.PlainText:
            ...
            ;(w && a && (r = !0),
              S.length > 0 &&
                (r && (i.push(' '), (r = !1)), i.push(S), o.push(d), (a = !0)),
              b && a && (r = !0))
            break
          case g.SoftBreak:
            ;(a && (r = !0), o.push(d))
          ...
          default:
            ;(r && (i.push(' '), (r = !1)),
              i.length > 0 &&
                (t.push(
                  new Ve({ configuration: e.configuration, text: i.join('') }),
                ),
                (i.length = 0),
                (o.length = 0)),
              t.push(d),
      ...
      if (e !== void 0)
        switch (e.kind) {
          ...
          case g.HtmlStartTag:
            ...
            for (
              var S =
                  b.spacingAfterName === void 0 ||
                  b.spacingAfterName.length === 0,
                k = 0,
                E = b.htmlAttributes;
              k < E.length;
              k++
    ...
    (n.extract = function (e) {
      for (
        ...
        switch (d) {
          ...
          case pe.BeginComment2:
            if (_ === '*')
              (b === ' ' && ++c, (a = c), (l = c), (d = pe.CollectingFirstLine))
            else
              return (
                e.log.addMessageForTextRange(
                  v.CommentOpeningDelimiterSyntax,
...
`
                ...
                : n._whitespaceCharacterRegExp.test(_) ||
  ...
  return (
    ...
    (n.prototype._parseParamBlock = function (e, t, r) {
      ...
      if (l) {
        ...
        var k = l
        ;(S &&
          (k = t.getTokenSequence().getNewSequence(l.startIndex, S.endIndex)),
          this._parserContext.log.addMessageForTokenSequence(
    ...
    (n.prototype._parseInlineTag = function (e) {
      ...
      var w = e.extractAccumulatedSequence(),
        ...
        k = new $r(
          this._parserContext,
          _ || xt.createEmpty(this._parserContext),
        ),
        E
      switch (S) {
    ...
    (n.prototype._parseFencedCode = function (e) {
      ...
      for (var E; !l; )
        switch (e.peekTokenKind()) {
          ...
          case u.Newline:
            for (
              E = e.readToken(), S = e.createMarker();
              e.peekTokenKind() === u.Spacing;
...
var ie = 'top',
  ...
  Gr = jt.reduce(function (n, e) {
    return n.concat([e + '-' + lt, e + '-' + Ot])
  }, []),
  dr = [].concat(jt, [ur]).reduce(function (n, e) {
    return n.concat([e, e + '-' + lt, e + '-' + Ot])
  }, []),
  cs = 'beforeRead',
  ls = 'read',
  ps = 'afterRead',
...
function Ae(n) {
  return ((Me(n) ? n.ownerDocument : n.document) || window.document)
    .documentElement
}
function ut(n) {
  return me(n) === 'html'
...
function Le(n) {
  for (var e = Z(n), t = go(n); t && Wr(t) && we(t).position === 'static'; )
    t = go(t)
  return t &&
    (me(t) === 'html' || (me(t) === 'body' && we(t).position === 'static'))
    ? e
    : t || xs(n) || e
}
function Ft(n) {
...
function zr(n) {
  ...
  return (
    we(i || t).direction === 'rtl' &&
      (l += qe(t.clientWidth, i ? i.clientWidth : 0) - o),
...
function jo(n, e, t) {
  return e === fr ? rn(Vr(n, t)) : Me(e) ? Cs(e, t) : rn(zr(Ae(n)))
}
function Ds(n) {
  var e = vt(ut(n)),
...
function Qr(n, e) {
  ...
  var b = w.reduce(function (S, k) {
    return (
      (S[k] = He(n, { placement: k, boundary: i, rootBoundary: o, padding: a })[
        ge(k)
      ]),
      S
    )
        ...
        var Rt = S ? 3 : 1,
          Ue = function (N) {
            var q = D.find(function (ee) {
              var et = J.get(ee)
              if (et)
                return et.slice(0, N).every(function (W) {
                  return W
                })
            })
...
var ko = { name: 'popperOffsets', enabled: !0, phase: 'read', fn: Is, data: {} }
function Xr(n) {
  return n === 'x' ? 'y' : 'x'
}
function Fs(n) {
  ...
  if (!!F) {
    if (o) {
      var f,
        ...
        ee = N[Ee],
        et = qt(0, J[_e], B[_e]),
        W = K ? J[_e] / 2 - Rt - et - q - Q.mainAxis : Ue - et - q - Q.mainAxis,
        je = K
          ? -J[_e] / 2 + Rt + et + ee + Q.mainAxis
          : Ze + et + ee + Q.mainAxis,
        Tt = e.elements.arrow && Le(e.elements.arrow),
        Nn = Tt ? (D === 'y' ? Tt.clientTop || 0 : Tt.clientLeft || 0) : 0,
        tt = (f = h == null ? void 0 : h[D]) != null ? f : 0,
        nt = xe + W - tt - Nn,
        gt = xe + je - tt,
        kt = qt(b ? Bt(Ye, nt) : Ye, xe, b ? qe(ke, gt) : ke)
      ;((F[D] = kt), (C[D] = kt - xe))
    }
    if (l) {
      var Mn,
        ...
        qn = cn ? In : rt - J[Yt] - te[Yt] - St + Q.altAxis,
        Ge = cn ? rt + J[Yt] + te[Yt] - St - Q.altAxis : Fn,
        se = b && cn ? ho(qn, rt, Ge) : qt(b ? qn : In, rt, b ? Ge : Fn)
      ;((F[H] = se), (C[H] = se - rt))
    }
    e.modifiersData[r] = C
  }
...
var Co = { placement: 'bottom', modifiers: [], strategy: 'absolute' }
function Do() {
...
var Hs = [yo, ko, xo, mo, To, vo, So, Ao, Eo],
  oi = Po({ defaultModifiers: Hs })
var $s = (n, e) => ((n % e) + e) % e,
  Mo = class {
    constructor(e, t, r) {
      ;((this.owner = e),
  ...
  kn = class {
    constructor(e, t) {
      ;((this.app = e),
        (this.inputEl = t),
        (this.scope = new No.Scope()),
        (this.suggestEl = createDiv('suggestion-container')))
      let r = this.suggestEl.createDiv('suggestion')
      ;((this.suggest = new Mo(this, r, this.scope)),
...
var Sn = class extends kn {
  ...
  getSuggestions(e) {
    ...
    return (
      t.forEach((o) => {
        o instanceof Bo.TFolder && o.path.toLowerCase().contains(i) && r.push(o)
      }),
      r.slice(0, 1e3)
    )
  }
...
var Ho = 'Error_MobileUnsupportedTemplate',
  $o =
  ...
  li = class extends be {
    ...
    generate_create_new() {
      return async (e, t, r = !1, i) => {
        if (((this.create_new_depth += 1), this.create_new_depth > Ko))
          throw (
            (this.create_new_depth = 0),
            new P('Reached create_new depth limit (max = 10)')
          )
    ...
    generate_include() {
      return async (e) => {
        if (((this.include_depth += 1), this.include_depth > Ko))
          throw (
            (this.include_depth -= 1),
            new P('Reached inclusion depth limit (max = 10)')
          )
        let t
        if (e instanceof le.TFile) t = await this.plugin.app.vault.read(e)
          ...
          if (!a)
            throw ((this.include_depth -= 1), new P(`File ${e} doesn't exist`))
    ...
    generate_selection() {
      return () => {
        ...
        if (!e || !e.editor)
          throw new P("Active editor is null, can't read selection.")
...
> \u2014 ${o}`
        ...
        return (
          new P('Error generating daily quote'),
  ...
  generate_random_picture() {
    return async (e, t, r = !1) => {
      try {
        ...
        return (
          new P('Error generating random picture'),
...
var wt = X(require('obsidian'))
var di = class extends wt.Modal {
  constructor(e, t, r, i) {
    super(e)
    this.prompt_text = t
  ...
  createForm() {
    ...
    let t = new wt.TextAreaComponent(e),
      r = this.contentEl.createDiv()
    r.addClass('templater-button-div')
    let i = new wt.ButtonComponent(r)
...
var Yo = X(require('obsidian')),
  mi = class extends Yo.FuzzySuggestModal {
...
var De = X(require('obsidian')),
  ...
  Uo = class extends De.AbstractInputSuggest {
    constructor(e, t, r, i, o) {
      super(e, t)
      this.getItemText = r
      this.items = i
...
var xi = class {
  constructor(e) {
    ...
    if (
      ...
      !(this.plugin.app.vault.adapter instanceof Cn.FileSystemAdapter)
    )
      this.cwd = ''
    else {
...
var ji = class {
  constructor(e) {
    this.plugin = e
    ;((this.user_system_functions = new xi(e)),
      (this.user_script_functions = new yi(e)))
  }
  async generate_object(e) {
    let t = {},
      r = {}
...
var vi = class {
  constructor(e) {
    this.plugin = e
    ;((this.internal_functions = new _i(this.plugin)),
      (this.user_functions = new ji(this.plugin)))
  }
  async init() {
...
var Go = new TextDecoder('utf-8', { ignoreBOM: !0, fatal: !0 })
Go.decode()
...
function bt(n, e) {
  return Go.decode(xr().subarray(n, n + e))
}
function Et(n) {
...
var Kt = class {
    ...
    constructor(e, t, r, i, o, a, l) {
      let c = mt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
        d = Re,
        m = mt(t, M.__wbindgen_malloc, M.__wbindgen_realloc),
        _ = Re,
        w = mt(l, M.__wbindgen_malloc, M.__wbindgen_realloc),
        b = Re,
    ...
    set opening_tag(e) {
      let t = mt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
        r = Re
    ...
    render_content(e, t) {
      try {
        let a = M.__wbindgen_add_to_stack_pointer(-16),
          l = mt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
          c = Re
...
function zs() {
  ...
  return (
    ...
    (n.wbg.__wbindgen_string_get = function (e, t) {
      ...
      var o = Us(i) ? 0 : mt(i, M.__wbindgen_malloc, M.__wbindgen_realloc),
        a = Re
    ...
    (n.wbg.__wbindgen_debug_string = function (e, t) {
      let r = bi(Pe(t)),
        i = mt(r, M.__wbindgen_malloc, M.__wbindgen_realloc),
        o = Re
...
var Pn = class {
  constructor(e) {
    this.plugin = e
    ;((this.functions_generator = new vi(this.plugin)),
      (this.parser = new Ti()))
  }
  async setup() {
...
`),
  ...
  static async on_file_creation(e, t, r) {
    ...
    if (
      (r.path.includes(i) && i !== '/') ||
      (await yt(300), e.files_with_pending_templates.has(r.path))
    )
      return
    ...
    if (l == 0 && e.plugin.settings.enable_folder_templates) {
      ...
      r.stat.size <= c
        ...
        : console.log(
            `Templater skipped parsing ${r.path} because file size exceeds ${c}`,
          )
    }
  }
    ...
    update_trigger_file_on_creation() {
      this.settings.trigger_on_file_creation
        ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on(
            'create',
            (e) => Pn.on_file_creation(this.templater, this.plugin.app, e),
          )),
    ...
    ;(e.editor.transaction({
      ...
      o &&
        ...
        e instanceof Si.MarkdownView &&
          (e.currentMode.applyFoldInfo(o), await yt(100), e.save())))
    try {
...
`,
  ...
  get_cursor_matches_and_positions(e) {
    ...
    r.sort(
      (d, m) => Number(d.groups?.order || 0) - Number(m.groups?.order || 0),
    )
    let i = r[0][0],
      o = r.filter((d) => d[0] === i),
      a = o[0][1] === '' ? [o[0]] : o,
  ...
  async get_all_functions_documentation(e, t) {
    ...
    if (e === 'user') {
      ...
      let r = await Se(async () => {
        ...
        return await so(this.plugin.app, i)
      }, "User Scripts folder doesn't exist")
      return !r || r.length === 0
        ? void 0
        : r.reduce(
  ...
  get_app_functions_documentation(e, t) {
    ...
    for (let c in i) {
      ...
      l.push({
        name: c,
        queryKey: m,
        definition: typeof i[c] == 'function' ? `${d}(${lo(i[c])})` : d,
        description: '',
        returns: '',
        example: '',
      })
...
var Ni = class extends ea.EditorSuggest {
  constructor(e) {
    super(e.app)
    this.tp_keyword_regex =
      /tp\.(?<module>[a-z]*)?(?<fn_trigger>\.(?<fn>[a-zA-Z_.]*)?)?$/
    ;((this.documentation = new Pi(e)),
  ...
  renderSuggestion(e, t) {
    if ((t.createEl('b', { text: e.name }), Di(e))) {
      if (
        ...
        Fo(this.intellisense_render_setting)
      ) {
      ...
      e.returns &&
        Io(this.intellisense_render_setting) &&
        Ur(t, 'Returns', e.returns)
    }
    ;(this.function_trigger &&
      Di(e) &&
      t.createEl('code', { text: e.definition }),
      e.description &&
        qo(this.intellisense_render_setting) &&
  ...
  ;(n.defineMode('javascript', function (e, t) {
    ...
    function Ee(s) {
      ...
      if (((h.marked = 'def'), !!l)) {
        ...
        t.globalVars &&
          !Ie(s, p.globalVars) &&
          (p.globalVars = new ke(s, p.globalVars))
      }
    }
    function _e(s, p) {
      if (p)
    ...
    function B(s, p) {
      var A = function () {
        ...
        if (x.lexical.type == 'stat') I = x.lexical.indented
          ...
          for (var Y = x.lexical; Y && Y.type == ')' && Y.align; Y = Y.prev)
            I = Y.indented
                  ...
                  : s == ';'
                    ...
                    : s == 'if'
                      ...
                      : s == 'function'
                        ? f(At)
                        : s == 'for'
                          ? f(B('form'), Ze, $i, ee, ye, N)
                          : s == 'class' || (c && p == 'interface')
                            ? ((h.marked = 'keyword'),
                              f(B('form', s == 'class' ? s : p), Ri, N))
                            : s == 'variable'
                              ? c && p == 'declare'
    ...
    function qn(s) {
      return s != 'variable' ? C(Ge) : ((h.marked = 'property'), f(At))
    }
    function Ge(s) {
      if (s == ':') return f(je)
      if (s == '(') return C(At)
    ...
    function qi(s) {
      if (c && s == ':')
        return h.stream.match(/^\s*\w+\s+is\b/, !1) ? f(W, oa, V) : f(V)
    }
    function oa(s, p) {
    ...
    function V(s, p) {
      ...
      if (s == '[') return f(B(']'), se(V, ']', ','), N, it)
      if (s == '{') return f(B('}'), Tr, N, it)
      if (s == '(') return f(se(Sr, ')'), aa, it)
      if (s == '<') return f(se(V, '>'), V)
      if (s == 'quasi') return C(kr, it)
    }
    function aa(s) {
      if (s == '=>') return f(V)
    }
    ...
    function pn(s, p) {
      ...
      if (s == ':') return f(V)
      if (s == '[') return f(q('variable'), ia, q(']'), pn)
      if (s == '(') return C(Wt, pn)
      if (!s.match(/[;\}\)\],]/)) return f()
    }
    function kr(s, p) {
    ...
    function sa(s) {
      if (s == '}')
        return ((h.marked = 'string-2'), (h.state.tokenize = D), f(kr))
    }
    function Sr(s, p) {
    ...
    function Cr(s, p) {
      return p == 'enum' ? ((h.marked = 'keyword'), f(Gi)) : C(Fe, Ut, ht, ua)
    }
    function Fe(s, p) {
    ...
    function At(s, p) {
      ...
      if (s == 'variable') return (Ee(p), f(At))
      if (s == '(') return f(Ue, B(')'), se(Ct, ')'), N, qi, ee, ye)
      if (c && p == '<') return f(B('>'), se(Hn, '>'), N, At)
    }
    function Wt(s, p) {
    ...
    function ot(s, p) {
      ...
      if (s == 'variable' || h.style == 'keyword')
        return ((h.marked = 'property'), f(un, ot))
      if (s == 'number' || s == 'string') return f(un, ot)
      if (s == '[') return f(W, Ut, q(']'), un, ot)
      if (p == '*') return ((h.marked = 'keyword'), f(ot))
      if (c && s == '(') return C(Wt, ot)
      if (s == ';' || s == ',') return f(ot)
      if (s == '}') return f()
      if (p == '@') return f(W, ot)
    }
...
var ta = X(require('@codemirror/language')),
  ...
  Ii = class {
    constructor(e) {
      this.plugin = e
      ;((this.cursor_jumper = new Ci(e.app)),
        (this.activeEditorExtensions = []))
    }
    desktopShouldHighlight() {
      return (
        Mi.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting
      )
    }
    mobileShouldHighlight() {
      return (
        Mi.Platform.isMobile && this.plugin.settings.syntax_highlighting_mobile
      )
    }
    async setup() {
          ...
          token: function (o, a) {
            if ((o.sol() && a.inCommand && (a.freeLine = !0), a.inCommand)) {
              ...
              if (o.match(/[-_]{0,1}%>/, !0)) {
                ...
                let m = a.tag_class
                return ((a.tag_class = ''), `line-${Bi} ${Oi} ${ic} ${m}`)
              }
...
var Fi = class extends Er.Plugin {
  ...
  async load_settings() {
    this.settings = Object.assign({}, Lo, await this.loadData())
  }
}
