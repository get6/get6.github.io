...
var Lr = (r) => $t(r, '__esModule', { value: !0 })
var Qi = (r, e) => {
    Lr(r)
    for (var t in e) $t(r, t, { get: e[t], enumerable: !0 })
  },
  Xi = (r, e, t) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let n of zi(e))
        !Wi.call(r, n) &&
          ...
          $t(r, n, {
            get: () => e[n],
            enumerable: !(t = Vi(e, n)) || t.enumerable,
          })
    return r
  },
  G = (r) =>
...
Qi(exports, { default: () => Tr })
var xn = G(require('obsidian'))
var P = G(require('obsidian'))
var Hr = G(require('obsidian'))
function z(r) {
  let e = new Hr.Notice('', 8e3),
    t = createFragment((n) => {
      ;(n.createEl('b', { text: 'Templater error' }),
        n.createSpan({ text: ':' }),
        n.createEl('br'),
        n.createSpan({ text: r.message }),
        r instanceof T &&
          r.console_msg &&
          (n.createEl('br'),
          n.createSpan({ text: 'Check console for more information' }),
          console.error(
            'Templater Error:',
            r.message,
            `
...
async function ne(r, e) {
  try {
    ...
    return (
      t instanceof T
        ? z(t)
        : z(new T(e, t instanceof Error ? t.message : void 0)),
      null
    )
  }
}
function ce(r, e) {
  try {
    ...
    return (z(new T(e, t instanceof Error ? t.message : void 0)), null)
  }
}
var J = (function () {
  function r() {}
  return (
    (r.explainIfInvalidTSDocTagName = function (e) {
      if (e[0] !== '@') return 'A TSDoc tag name must start with an "@" symbol'
      if (!r._tsdocTagNameRegExp.test(e))
        return 'A TSDoc tag name must start with a letter and contain only letters and numbers'
    }),
    (r.validateTSDocTagName = function (e) {
      var t = r.explainIfInvalidTSDocTagName(e)
      if (t) throw new Error(t)
    }),
    (r.explainIfInvalidLinkUrl = function (e) {
      if (e.length === 0) return 'The URL cannot be empty'
      if (!r._urlSchemeRegExp.test(e))
      ...
      if (!r._urlSchemeAfterRegExp.test(e))
        return 'An @link URL must have at least one character after "://"'
    }),
    (r.explainIfInvalidHtmlName = function (e) {
      if (!r._htmlNameRegExp.test(e))
        return 'An HTML name must be an ASCII letter followed by zero or more letters, digits, or hyphens'
    }),
    (r.validateHtmlName = function (e) {
      var t = r.explainIfInvalidHtmlName(e)
      if (t) throw new Error(t)
    }),
    (r.explainIfInvalidPackageName = function (e) {
      if (e.length === 0) return 'The package name cannot be an empty string'
      if (!r._validPackageNameRegExp.test(e))
        return 'The package name '.concat(
          JSON.stringify(e),
          ' is not a valid package name',
        )
    }),
    (r.explainIfInvalidImportPath = function (e, t) {
      if (e.length > 0) {
    ...
    (r.isSystemSelector = function (e) {
      return r._systemSelectors.has(e)
    }),
    (r.explainIfInvalidUnquotedIdentifier = function (e) {
      if (e.length === 0) return 'The identifier cannot be an empty string'
      if (r._identifierBadCharRegExp.test(e))
        return 'The identifier cannot non-word characters'
      if (r._identifierNumberStartRegExp.test(e))
        return 'The identifier must not start with a number'
    }),
    (r.explainIfInvalidUnquotedMemberIdentifier = function (e) {
      var t = r.explainIfInvalidUnquotedIdentifier(e)
      if (t !== void 0) return t
      if (r.isSystemSelector(e))
        return 'The identifier "'.concat(
          e,
          '" must be quoted because it is a TSDoc system selector name',
        )
    }),
    (r._tsdocTagNameRegExp = /^@[a-z][a-z0-9]*$/i),
    (r._urlSchemeRegExp = /^[a-z][a-z0-9]*\:\/\//i),
    (r._urlSchemeAfterRegExp = /^[a-z][a-z0-9]*\:\/\/./i),
    (r._htmlNameRegExp = /^[a-z]+[a-z0-9\-]*$/i),
    (r._identifierBadCharRegExp = /[^a-z0-9_$]/i),
    (r._identifierNumberStartRegExp = /^[0-9]/),
    (r._validPackageNameRegExp = /^(?:@[a-z0-9\-_\.]+\/)?[a-z0-9\-_\.]+$/i),
    (r._systemSelectors = new Set([
      'instance',
      'static',
      'constructor',
      'class',
...
var Dn = (function () {
  ...
  return (
    (r.prototype.registerDocNodes = function (e, t) {
      var n = J.explainIfInvalidPackageName(e)
      if (n) throw new Error('Invalid NPM package name: ' + n)
      for (var i = 0, o = t; i < o.length; i++) {
        var a = o[i]
        if (!r._nodeKindRegExp.test(a.docNodeKind))
          throw new Error(
        ...
        ;(this._docNodeDefinitionsByKind.set(a.docNodeKind, u),
          this._docNodeDefinitionsByConstructor.set(a.constructor, u))
      }
    }),
    (r.prototype.throwIfNotRegisteredKind = function (e) {
    ...
    (r.prototype.registerAllowableChildren = function (e, t) {
      for (var n = this._getDefinition(e), i = 0, o = t; i < o.length; i++) {
        var a = o[i]
        ;(this._getDefinition(a), n.allowedChildKinds.add(a))
      }
    }),
    (r.prototype.isAllowedChild = function (e, t) {
      var n = this._getDefinition(e)
      return n.allowedChildKinds.has(t)
    }),
    (r.prototype._getDefinition = function (e) {
    ...
    (r._nodeKindRegExp = /^[_a-z][_a-z0-9]*$/i),
    r
  )
})()
var q
...
var F
;(function (r) {
  ;((r[(r.InlineTag = 0)] = 'InlineTag'),
    (r[(r.BlockTag = 1)] = 'BlockTag'),
    (r[(r.ModifierTag = 2)] = 'ModifierTag'))
})(F || (F = {}))
var Pn = (function () {
  function r(e) {
    ;(J.validateTSDocTagName(e.tagName),
      (this.tagName = e.tagName),
      (this.tagNameWithUpperCase = e.tagName.toUpperCase()),
      (this.syntaxKind = e.syntaxKind),
      (this.standardization = e.standardization || q.None),
      (this.allowMultiple = !!e.allowMultiple))
  }
  return (
    (r.validateTSDocTagName = function (e) {
      J.validateTSDocTagName(e)
    }),
    r
  )
})()
var L = (function () {
  function r() {}
  return (
    (r._defineTag = function (e) {
      return new Pn(e)
    }),
    (r.alpha = r._defineTag({
      tagName: '@alpha',
      syntaxKind: F.ModifierTag,
      standardization: q.Discretionary,
    })),
    (r.beta = r._defineTag({
      tagName: '@beta',
      syntaxKind: F.ModifierTag,
    ...
    (r.decorator = r._defineTag({
      tagName: '@decorator',
      syntaxKind: F.BlockTag,
      allowMultiple: !0,
      standardization: q.Extended,
    })),
    (r.defaultValue = r._defineTag({
      tagName: '@defaultValue',
      syntaxKind: F.BlockTag,
      standardization: q.Extended,
    })),
    (r.deprecated = r._defineTag({
      tagName: '@deprecated',
      syntaxKind: F.BlockTag,
      standardization: q.Core,
    })),
    (r.eventProperty = r._defineTag({
      tagName: '@eventProperty',
      syntaxKind: F.ModifierTag,
      standardization: q.Extended,
    })),
    (r.example = r._defineTag({
      tagName: '@example',
      syntaxKind: F.BlockTag,
      allowMultiple: !0,
      standardization: q.Extended,
    })),
    (r.experimental = r._defineTag({
      tagName: '@experimental',
      syntaxKind: F.ModifierTag,
      standardization: q.Discretionary,
    })),
    (r.inheritDoc = r._defineTag({
      tagName: '@inheritDoc',
      syntaxKind: F.InlineTag,
      standardization: q.Extended,
    })),
    (r.internal = r._defineTag({
      tagName: '@internal',
      syntaxKind: F.ModifierTag,
      standardization: q.Discretionary,
    })),
    (r.label = r._defineTag({
      tagName: '@label',
      syntaxKind: F.InlineTag,
      standardization: q.Core,
    })),
    ...
    (r.override = r._defineTag({
      tagName: '@override',
      syntaxKind: F.ModifierTag,
      standardization: q.Extended,
    })),
    (r.packageDocumentation = r._defineTag({
      tagName: '@packageDocumentation',
      syntaxKind: F.ModifierTag,
      standardization: q.Core,
    })),
    (r.param = r._defineTag({
      tagName: '@param',
      syntaxKind: F.BlockTag,
      allowMultiple: !0,
      standardization: q.Core,
    })),
    (r.privateRemarks = r._defineTag({
      tagName: '@privateRemarks',
      syntaxKind: F.BlockTag,
      standardization: q.Core,
    })),
    (r.public = r._defineTag({
      tagName: '@public',
      syntaxKind: F.ModifierTag,
      standardization: q.Discretionary,
    })),
    (r.readonly = r._defineTag({
      tagName: '@readonly',
      syntaxKind: F.ModifierTag,
      standardization: q.Extended,
    })),
    (r.remarks = r._defineTag({
      tagName: '@remarks',
      syntaxKind: F.BlockTag,
      standardization: q.Core,
    })),
    (r.returns = r._defineTag({
      tagName: '@returns',
      syntaxKind: F.BlockTag,
      standardization: q.Core,
    })),
    (r.sealed = r._defineTag({
      tagName: '@sealed',
      syntaxKind: F.ModifierTag,
      standardization: q.Extended,
    })),
    ...
    (r.throws = r._defineTag({
      tagName: '@throws',
      syntaxKind: F.BlockTag,
      allowMultiple: !0,
      standardization: q.Extended,
    })),
    (r.typeParam = r._defineTag({
      tagName: '@typeParam',
      syntaxKind: F.BlockTag,
      allowMultiple: !0,
      standardization: q.Core,
    })),
    (r.virtual = r._defineTag({
      tagName: '@virtual',
      syntaxKind: F.ModifierTag,
      standardization: q.Extended,
    })),
...
;(function (r) {
  ;((r.Block = 'Block'),
    (r.BlockTag = 'BlockTag'),
    (r.Excerpt = 'Excerpt'),
    (r.FencedCode = 'FencedCode'),
    (r.CodeSpan = 'CodeSpan'),
    (r.Comment = 'Comment'),
    (r.DeclarationReference = 'DeclarationReference'),
    (r.ErrorText = 'ErrorText'),
    (r.EscapedText = 'EscapedText'),
    (r.HtmlAttribute = 'HtmlAttribute'),
    (r.HtmlEndTag = 'HtmlEndTag'),
    (r.HtmlStartTag = 'HtmlStartTag'),
    (r.InheritDocTag = 'InheritDocTag'),
    (r.InlineTag = 'InlineTag'),
    (r.LinkTag = 'LinkTag'),
    (r.MemberIdentifier = 'MemberIdentifier'),
    (r.MemberReference = 'MemberReference'),
    (r.MemberSelector = 'MemberSelector'),
    (r.MemberSymbol = 'MemberSymbol'),
    (r.Paragraph = 'Paragraph'),
    (r.ParamBlock = 'ParamBlock'),
    (r.ParamCollection = 'ParamCollection'),
    (r.PlainText = 'PlainText'),
    (r.Section = 'Section'),
    (r.SoftBreak = 'SoftBreak'))
})(g || (g = {}))
var v = (function () {
  function r(e) {
  ...
  return (
    (r.prototype.getChildNodes = function () {
      return (
    ...
    (r.prototype.onGetChildNodes = function () {
      return []
    }),
    (r.isParsedParameters = function (e) {
      return e.parsed === !0
    }),
    r
  )
  ...
  return (
    (r.register = function (e) {
      ...
      ;(t.registerDocNodes('@microsoft/tsdoc', [
        { docNodeKind: g.Block, constructor: it },
        { docNodeKind: g.BlockTag, constructor: Ht },
        { docNodeKind: g.CodeSpan, constructor: Kt },
        { docNodeKind: g.Comment, constructor: Ut },
        { docNodeKind: g.DeclarationReference, constructor: Yt },
        { docNodeKind: g.ErrorText, constructor: Ve },
        { docNodeKind: g.EscapedText, constructor: Rt },
        { docNodeKind: g.Excerpt, constructor: y },
        { docNodeKind: g.FencedCode, constructor: Gt },
        { docNodeKind: g.HtmlAttribute, constructor: Vt },
        { docNodeKind: g.HtmlEndTag, constructor: zt },
        { docNodeKind: g.HtmlStartTag, constructor: Jt },
        { docNodeKind: g.InheritDocTag, constructor: wt },
        { docNodeKind: g.InlineTag, constructor: ot },
        { docNodeKind: g.LinkTag, constructor: Wt },
        { docNodeKind: g.MemberIdentifier, constructor: vt },
        { docNodeKind: g.MemberReference, constructor: Qt },
        { docNodeKind: g.MemberSelector, constructor: Xt },
        { docNodeKind: g.MemberSymbol, constructor: Zt },
        { docNodeKind: g.Paragraph, constructor: ke },
        { docNodeKind: g.ParamBlock, constructor: Tt },
        { docNodeKind: g.ParamCollection, constructor: jt },
        { docNodeKind: g.PlainText, constructor: me },
        { docNodeKind: g.Section, constructor: Oe },
        { docNodeKind: g.SoftBreak, constructor: en },
      ]),
...
var w
;(function (r) {
  ;((r.ConfigFileNotFound = 'tsdoc-config-file-not-found'),
    (r.ConfigInvalidJson = 'tsdoc-config-invalid-json'),
    (r.ConfigFileUnsupportedSchema = 'tsdoc-config-unsupported-schema'),
    (r.ConfigFileSchemaError = 'tsdoc-config-schema-error'),
    (r.ConfigFileCyclicExtends = 'tsdoc-config-cyclic-extends'),
    (r.ConfigFileUnresolvedExtends = 'tsdoc-config-unresolved-extends'),
    (r.ConfigFileUndefinedTag = 'tsdoc-config-undefined-tag'),
    (r.ConfigFileDuplicateTagName = 'tsdoc-config-duplicate-tag-name'),
    (r.ConfigFileInvalidTagName = 'tsdoc-config-invalid-tag-name'),
    (r.CommentNotFound = 'tsdoc-comment-not-found'),
    (r.CommentOpeningDelimiterSyntax =
      'tsdoc-comment-missing-opening-delimiter'),
    (r.CommentMissingClosingDelimiter =
      'tsdoc-comment-missing-closing-delimiter'),
    (r.ExtraInheritDocTag = 'tsdoc-extra-inheritdoc-tag'),
    (r.EscapeRightBrace = 'tsdoc-escape-right-brace'),
    (r.EscapeGreaterThan = 'tsdoc-escape-greater-than'),
    (r.MissingDeprecationMessage = 'tsdoc-missing-deprecation-message'),
    (r.InheritDocIncompatibleTag = 'tsdoc-inheritdoc-incompatible-tag'),
    (r.InheritDocIncompatibleSummary = 'tsdoc-inheritdoc-incompatible-summary'),
    (r.InlineTagMissingBraces = 'tsdoc-inline-tag-missing-braces'),
    (r.TagShouldNotHaveBraces = 'tsdoc-tag-should-not-have-braces'),
    (r.UnsupportedTag = 'tsdoc-unsupported-tag'),
    (r.UndefinedTag = 'tsdoc-undefined-tag'),
    (r.ParamTagWithInvalidType = 'tsdoc-param-tag-with-invalid-type'),
    (r.ParamTagWithInvalidOptionalName =
      'tsdoc-param-tag-with-invalid-optional-name'),
    (r.ParamTagWithInvalidName = 'tsdoc-param-tag-with-invalid-name'),
    (r.ParamTagMissingHyphen = 'tsdoc-param-tag-missing-hyphen'),
    (r.UnnecessaryBackslash = 'tsdoc-unnecessary-backslash'),
    (r.MissingTag = 'tsdoc-missing-tag'),
    (r.AtSignInWord = 'tsdoc-at-sign-in-word'),
    (r.AtSignWithoutTagName = 'tsdoc-at-sign-without-tag-name'),
    (r.MalformedInlineTag = 'tsdoc-malformed-inline-tag'),
    (r.CharactersAfterBlockTag = 'tsdoc-characters-after-block-tag'),
    (r.MalformedTagName = 'tsdoc-malformed-tag-name'),
    (r.CharactersAfterInlineTag = 'tsdoc-characters-after-inline-tag'),
    (r.InlineTagMissingRightBrace = 'tsdoc-inline-tag-missing-right-brace'),
    (r.InlineTagUnescapedBrace = 'tsdoc-inline-tag-unescaped-brace'),
    (r.InheritDocTagSyntax = 'tsdoc-inheritdoc-tag-syntax'),
    (r.LinkTagEmpty = 'tsdoc-link-tag-empty'),
    (r.LinkTagUnescapedText = 'tsdoc-link-tag-unescaped-text'),
    (r.LinkTagDestinationSyntax = 'tsdoc-link-tag-destination-syntax'),
    (r.LinkTagInvalidUrl = 'tsdoc-link-tag-invalid-url'),
    (r.ReferenceMissingHash = 'tsdoc-reference-missing-hash'),
    (r.ReferenceHashSyntax = 'tsdoc-reference-hash-syntax'),
    (r.ReferenceMalformedPackageName =
      'tsdoc-reference-malformed-package-name'),
    (r.ReferenceMalformedImportPath = 'tsdoc-reference-malformed-import-path'),
    (r.MissingReference = 'tsdoc-missing-reference'),
    (r.ReferenceMissingDot = 'tsdoc-reference-missing-dot'),
    (r.ReferenceSelectorMissingParens =
      'tsdoc-reference-selector-missing-parens'),
    (r.ReferenceMissingColon = 'tsdoc-reference-missing-colon'),
    (r.ReferenceMissingRightParen = 'tsdoc-reference-missing-right-paren'),
    (r.ReferenceSymbolSyntax = 'tsdoc-reference-symbol-syntax'),
    (r.ReferenceMissingRightBracket = 'tsdoc-reference-missing-right-bracket'),
    (r.ReferenceMissingQuote = 'tsdoc-reference-missing-quote'),
    (r.ReferenceEmptyIdentifier = 'tsdoc-reference-empty-identifier'),
    (r.ReferenceMissingIdentifier = 'tsdoc-reference-missing-identifier'),
    (r.ReferenceUnquotedIdentifier = 'tsdoc-reference-unquoted-identifier'),
    (r.ReferenceMissingLabel = 'tsdoc-reference-missing-label'),
    (r.ReferenceSelectorSyntax = 'tsdoc-reference-selector-syntax'),
    (r.HtmlTagMissingGreaterThan = 'tsdoc-html-tag-missing-greater-than'),
    (r.HtmlTagMissingEquals = 'tsdoc-html-tag-missing-equals'),
    (r.HtmlTagMissingString = 'tsdoc-html-tag-missing-string'),
    (r.HtmlStringMissingQuote = 'tsdoc-html-string-missing-quote'),
    (r.TextAfterHtmlString = 'tsdoc-text-after-html-string'),
    (r.MissingHtmlEndTag = 'tsdoc-missing-html-end-tag'),
    (r.MalformedHtmlName = 'tsdoc-malformed-html-name'),
    (r.UnsupportedHtmlElementName = 'tsdoc-unsupported-html-name'),
    (r.CodeFenceOpeningIndent = 'tsdoc-code-fence-opening-indent'),
    (r.CodeFenceSpecifierSyntax = 'tsdoc-code-fence-specifier-syntax'),
    (r.CodeFenceClosingIndent = 'tsdoc-code-fence-closing-indent'),
    (r.CodeFenceMissingDelimiter = 'tsdoc-code-fence-missing-delimiter'),
    (r.CodeFenceClosingSyntax = 'tsdoc-code-fence-closing-syntax'),
    (r.CodeSpanEmpty = 'tsdoc-code-span-empty'),
    (r.CodeSpanMissingDelimiter = 'tsdoc-code-span-missing-delimiter'))
})(w || (w = {}))
var tn = [
...
var Mn = (function () {
  function r() {
    ;((this._tagDefinitions = []),
      ...
      (this._validation = new Nn()),
      (this._docNodeManager = new Dn()),
  ...
  return (
    (r.prototype.clear = function (e) {
      ;(e === void 0 && (e = !1),
        ...
        e || this.addTagDefinitions(L.allDefinitions))
    }),
    Object.defineProperty(r.prototype, 'tagDefinitions', {
      get: function () {
    ...
    Object.defineProperty(r.prototype, 'supportedTagDefinitions', {
      get: function () {
        var e = this
    ...
    Object.defineProperty(r.prototype, 'validation', {
      get: function () {
    ...
    Object.defineProperty(r.prototype, 'supportedHtmlElements', {
      get: function () {
    ...
    Object.defineProperty(r.prototype, 'docNodeManager', {
      get: function () {
    ...
    (r.prototype.tryGetTagDefinition = function (e) {
      return this._tagDefinitionsByName.get(e.toUpperCase())
    }),
    (r.prototype.tryGetTagDefinitionWithUpperCase = function (e) {
      return this._tagDefinitionsByName.get(e)
    }),
    (r.prototype.addTagDefinition = function (e) {
    ...
    (r.prototype.setSupportForTags = function (e, t) {
      for (var n = 0, i = e; n < i.length; n++) {
        var o = i[n]
        this.setSupportForTag(o, t)
      }
    }),
    (r.prototype.setSupportedHtmlElements = function (e) {
      ;(this._supportedHtmlElements.clear(),
    ...
    (r.prototype.isHtmlElementSupported = function (e) {
      return this._supportedHtmlElements.has(e)
    }),
    (r.prototype.isKnownMessageId = function (e) {
      return Ur.has(e)
    }),
    Object.defineProperty(r.prototype, 'allTsdocMessageIds', {
      get: function () {
        return tn
      },
      enumerable: !1,
    ...
    (r.prototype._requireTagToBeDefined = function (e) {
      var t = this._tagDefinitionsByName.get(e.tagNameWithUpperCase)
      if (!(t && t === e))
        throw new Error(
...
var Fn = (function () {
  ...
  return (
    ...
    (r.prototype.hasTagName = function (e) {
      return this._nodesByName.has(e.toUpperCase())
    }),
    (r.prototype.hasTag = function (e) {
      return !!this.tryGetTag(e)
    }),
    (r.prototype.tryGetTag = function (e) {
      if (e.syntaxKind !== F.ModifierTag)
  ...
  In = (function (r) {
    ...
    return (
      (e.prototype.isAlpha = function () {
        return this.hasTag(L.alpha)
      }),
      (e.prototype.isBeta = function () {
        return this.hasTag(L.beta)
      }),
      (e.prototype.isEventProperty = function () {
        return this.hasTag(L.eventProperty)
      }),
      (e.prototype.isExperimental = function () {
        return this.hasTag(L.experimental)
      }),
      (e.prototype.isInternal = function () {
        return this.hasTag(L.internal)
      }),
      (e.prototype.isOverride = function () {
        return this.hasTag(L.override)
      }),
      (e.prototype.isPackageDocumentation = function () {
        return this.hasTag(L.packageDocumentation)
      }),
      (e.prototype.isPublic = function () {
        return this.hasTag(L.public)
      }),
      (e.prototype.isReadonly = function () {
        return this.hasTag(L.readonly)
      }),
      (e.prototype.isSealed = function () {
        return this.hasTag(L.sealed)
      }),
      (e.prototype.isVirtual = function () {
        return this.hasTag(L.virtual)
      }),
      e
    )
  })(Fn)
var eo = (function () {
  ...
  nn = (function (r) {
    ...
    function e(t, n) {
      ...
      return (
        (i._nodes = []),
        n !== void 0 && n.length > 0 && i.appendNodes(n),
        i
      )
    }
    return (
    ...
    return (
      ...
      (e.prototype.appendNodeInParagraph = function (t) {
        ...
        if (this.nodes.length > 0) {
          ...
          i.kind === g.Paragraph && (n = i)
        }
        ;(n ||
          ((n = new ke({ configuration: this.configuration })),
          this.appendNode(n)),
          n.appendNode(t))
      }),
...
var ro = (function () {
  ...
  it = (function (r) {
    ...
    function e(t) {
      ...
      return (
        (n._blockTag = t.blockTag),
        (n._content = new Oe({ configuration: n.configuration })),
        n
      )
    }
    return (
...
var p
;(function (r) {
  ;((r[(r.EndOfInput = 2001)] = 'EndOfInput'),
    (r[(r.Newline = 2002)] = 'Newline'),
    (r[(r.Spacing = 2003)] = 'Spacing'),
    (r[(r.AsciiWord = 2004)] = 'AsciiWord'),
    (r[(r.OtherPunctuation = 2005)] = 'OtherPunctuation'),
    (r[(r.Other = 2006)] = 'Other'),
    (r[(r.Backslash = 2007)] = 'Backslash'),
    (r[(r.LessThan = 2008)] = 'LessThan'),
    (r[(r.GreaterThan = 2009)] = 'GreaterThan'),
    (r[(r.Equals = 2010)] = 'Equals'),
    (r[(r.SingleQuote = 2011)] = 'SingleQuote'),
    (r[(r.DoubleQuote = 2012)] = 'DoubleQuote'),
    (r[(r.Slash = 2013)] = 'Slash'),
    (r[(r.Hyphen = 2014)] = 'Hyphen'),
    (r[(r.AtSign = 2015)] = 'AtSign'),
    (r[(r.LeftCurlyBracket = 2016)] = 'LeftCurlyBracket'),
    (r[(r.RightCurlyBracket = 2017)] = 'RightCurlyBracket'),
    (r[(r.Backtick = 2018)] = 'Backtick'),
    (r[(r.Period = 2019)] = 'Period'),
    (r[(r.Colon = 2020)] = 'Colon'),
    (r[(r.Comma = 2021)] = 'Comma'),
    (r[(r.LeftSquareBracket = 2022)] = 'LeftSquareBracket'),
    (r[(r.RightSquareBracket = 2023)] = 'RightSquareBracket'),
    (r[(r.Pipe = 2024)] = 'Pipe'),
    (r[(r.LeftParenthesis = 2025)] = 'LeftParenthesis'),
    (r[(r.RightParenthesis = 2026)] = 'RightParenthesis'),
    (r[(r.PoundSymbol = 2027)] = 'PoundSymbol'),
    (r[(r.Plus = 2028)] = 'Plus'),
    (r[(r.DollarSign = 2029)] = 'DollarSign'))
})(p || (p = {}))
var ze = (function () {
  function r(e, t, n) {
    ;((this.kind = e), (this.range = t), (this.line = n))
  }
  return (
    (r.prototype.toString = function () {
      return this.kind === p.Newline
        ? `
`
        : this.range.toString()
    }),
...
;(function (r) {
  ;((r.Spacing = 'Spacing'),
    (r.BlockTag = 'BlockTag'),
    (r.CodeSpan_OpeningDelimiter = 'CodeSpan_OpeningDelimiter'),
    (r.CodeSpan_Code = 'CodeSpan_Code'),
    (r.CodeSpan_ClosingDelimiter = 'CodeSpan_ClosingDelimiter'),
    (r.DeclarationReference_PackageName = 'DeclarationReference_PackageName'),
    (r.DeclarationReference_ImportPath = 'DeclarationReference_ImportPath'),
    (r.DeclarationReference_ImportHash = 'DeclarationReference_ImportHash'),
    (r.ErrorText = 'ErrorText'),
    (r.NonstandardText = 'NonstandardText'),
    (r.EscapedText = 'EscapedText'),
    (r.FencedCode_OpeningFence = 'FencedCode_OpeningFence'),
    (r.FencedCode_Language = 'FencedCode_Language'),
    (r.FencedCode_Code = 'FencedCode_Code'),
    (r.FencedCode_ClosingFence = 'FencedCode_ClosingFence'),
    (r.HtmlAttribute_Name = 'HtmlAttribute_Name'),
    (r.HtmlAttribute_Equals = 'HtmlAttribute_Equals'),
    (r.HtmlAttribute_Value = 'HtmlAttribute_Value'),
    (r.HtmlEndTag_OpeningDelimiter = 'HtmlEndTag_OpeningDelimiter'),
    (r.HtmlEndTag_Name = 'HtmlEndTag_Name'),
    (r.HtmlEndTag_ClosingDelimiter = 'HtmlEndTag_ClosingDelimiter'),
    (r.HtmlStartTag_OpeningDelimiter = 'HtmlStartTag_OpeningDelimiter'),
    (r.HtmlStartTag_Name = 'HtmlStartTag_Name'),
    (r.HtmlStartTag_ClosingDelimiter = 'HtmlStartTag_ClosingDelimiter'),
    (r.InlineTag_OpeningDelimiter = 'InlineTag_OpeningDelimiter'),
    (r.InlineTag_TagName = 'InlineTag_TagName'),
    (r.InlineTag_TagContent = 'InlineTag_TagContent'),
    (r.InlineTag_ClosingDelimiter = 'InlineTag_ClosingDelimiter'),
    (r.LinkTag_UrlDestination = 'LinkTag_UrlDestination'),
    (r.LinkTag_Pipe = 'LinkTag_Pipe'),
    (r.LinkTag_LinkText = 'LinkTag_LinkText'),
    (r.MemberIdentifier_LeftQuote = 'MemberIdentifier_LeftQuote'),
    (r.MemberIdentifier_Identifier = 'MemberIdentifier_Identifier'),
    (r.MemberIdentifier_RightQuote = 'MemberIdentifier_RightQuote'),
    (r.MemberReference_Dot = 'MemberReference_Dot'),
    (r.MemberReference_LeftParenthesis = 'MemberReference_LeftParenthesis'),
    (r.MemberReference_Colon = 'MemberReference_Colon'),
    (r.MemberReference_RightParenthesis = 'MemberReference_RightParenthesis'),
    (r.MemberSelector = 'MemberSelector'),
    (r.DocMemberSymbol_LeftBracket = 'DocMemberSymbol_LeftBracket'),
    (r.DocMemberSymbol_RightBracket = 'DocMemberSymbol_RightBracket'),
    (r.ParamBlock_ParameterName = 'ParamBlock_ParameterName'),
    (r.ParamBlock_Hyphen = 'ParamBlock_Hyphen'),
    (r.PlainText = 'PlainText'),
    (r.SoftBreak = 'SoftBreak'))
})(x || (x = {}))
var y = (function (r) {
  ...
  function e(t) {
    ...
    return ((n._excerptKind = t.excerptKind), (n._content = t.content), n)
  }
  return (
    Object.defineProperty(e.prototype, 'kind', {
      get: function () {
...
var oo = (function () {
  ...
  Ht = (function (r) {
    ...
    function e(t) {
      var n = r.call(this, t) || this
      return (
        J.validateTSDocTagName(t.tagName),
        (n._tagName = t.tagName),
        (n._tagNameWithUpperCase = t.tagName.toUpperCase()),
        v.isParsedParameters(t) &&
          (n._tagNameExcerpt = new y({
...
var Yr = (function () {
  ...
  return (
    (r.transform = function (e) {
      for (
        var t = [], n = !1, i = [], o = [], a = !1, l = 0, u = e.nodes;
        l < u.length;
        l++
      ) {
        var d = u[l]
        switch (d.kind) {
          case g.PlainText:
            var h = d,
              ...
              E = /^\s/.test(j),
              M = /\s$/.test(j),
              I = j.replace(/\s+/g, ' ').trim()
            ;(E && a && (n = !0),
              I.length > 0 &&
                (n && (i.push(' '), (n = !1)), i.push(I), o.push(d), (a = !0)),
              M && a && (n = !0))
            break
          case g.SoftBreak:
            ;(a && (n = !0), o.push(d))
          ...
          default:
            ;(n && (i.push(' '), (n = !1)),
              i.length > 0 &&
                (t.push(
                  new me({ configuration: e.configuration, text: i.join('') }),
                ),
                (i.length = 0),
                (o.length = 0)),
              t.push(d),
      ...
      i.length > 0 &&
        (t.push(new me({ configuration: e.configuration, text: i.join('') })),
        (i.length = 0),
        (o.length = 0))
      var K = new ke({ configuration: e.configuration })
...
var Bn = (function () {
  function r() {}
  return (
    (r.trimSpacesInParagraph = function (e) {
      return Yr.transform(e)
    }),
    r
  )
})()
var On = function (r, e, t) {
...
;(function (r) {
  ;((r[(r.Closed = 0)] = 'Closed'),
    (r[(r.StartOfLine = 1)] = 'StartOfLine'),
    (r[(r.MiddleOfLine = 2)] = 'MiddleOfLine'))
})(ee || (ee = {}))
var Ce = (function () {
  function r() {
    ;((this.eol = `
`),
      ...
      (this._lineState = ee.Closed),
      (this._previousLineHadContent = !1),
      (this._hangingParagraph = !1))
  }
  return (
    (r.prototype.renderComment = function (e, t) {
      ;((this._emitCommentFraming = !0), this._renderCompleteObject(e, t))
    }),
    (r.prototype.renderHtmlTag = function (e, t) {
      ;((this._emitCommentFraming = !1), this._renderCompleteObject(e, t))
    }),
    (r.prototype.renderDeclarationReference = function (e, t) {
      ;((this._emitCommentFraming = !1), this._renderCompleteObject(e, t))
    }),
    (r.prototype._renderCompleteObject = function (e, t) {
      ;((this._output = e),
        (this._lineState = ee.Closed),
        (this._previousLineHadContent = !1),
        (this._hangingParagraph = !1),
    ...
    (r.prototype._renderNode = function (e) {
      var t = this
      if (e !== void 0)
        switch (e.kind) {
          case g.Block:
            ...
            ;(this._ensureLineSkipped(),
              this._renderNode(n.blockTag),
              n.blockTag.tagNameWithUpperCase ===
                L.returns.tagNameWithUpperCase &&
                (this._writeContent(' '), (this._hangingParagraph = !0)),
              this._renderNode(n.content))
            break
          case g.BlockTag:
            var i = e
            ;(this._lineState === ee.MiddleOfLine && this._writeContent(' '),
          ...
          case g.FencedCode:
            ...
            ;(this._ensureAtStartOfLine(),
              this._writeContent('```'),
              this._writeContent(h.language),
              this._writeNewline(),
              this._writeContent(h.code),
              this._writeContent('```'),
              this._writeNewline(),
              this._writeNewline())
            break
          case g.HtmlAttribute:
            var j = e
            ;(this._writeContent(j.name),
              this._writeContent(j.spacingAfterName),
              this._writeContent('='),
              this._writeContent(j.spacingAfterEquals),
              this._writeContent(j.value),
              this._writeContent(j.spacingAfterValue))
            break
          case g.HtmlEndTag:
            var E = e
            ;(this._writeContent('</'),
          ...
          case g.HtmlStartTag:
            var M = e
            ;(this._writeContent('<'),
              this._writeContent(M.name),
              this._writeContent(M.spacingAfterName))
            for (
              var I =
                  M.spacingAfterName === void 0 ||
                  M.spacingAfterName.length === 0,
                K = 0,
                D = M.htmlAttributes;
              K < D.length;
              K++
              ...
              var R = D[K]
              ;(I && this._writeContent(' '),
                this._renderNode(R),
                (I =
                  R.spacingAfterValue === void 0 ||
                  R.spacingAfterValue.length === 0))
            }
            this._writeContent(M.selfClosingTag ? '/>' : '>')
            break
          case g.InheritDocTag:
            var oe = e
            this._renderInlineTag(oe, function () {
              oe.declarationReference &&
                (t._writeContent(' '), t._renderNode(oe.declarationReference))
            })
            break
          case g.InlineTag:
            var ae = e
            this._renderInlineTag(ae, function () {
              ae.tagContent.length > 0 &&
                (t._writeContent(' '), t._writeContent(ae.tagContent))
            })
            break
          case g.LinkTag:
            var W = e
            this._renderInlineTag(W, function () {
              ;((W.urlDestination !== void 0 || W.codeDestination !== void 0) &&
                (W.urlDestination !== void 0
                  ? (t._writeContent(' '), t._writeContent(W.urlDestination))
                  : W.codeDestination !== void 0 &&
                    (t._writeContent(' '), t._renderNode(W.codeDestination))),
                W.linkText !== void 0 &&
                  (t._writeContent(' '),
                  t._writeContent('|'),
                  t._writeContent(' '),
                  t._writeContent(W.linkText)))
            })
            break
          case g.MemberIdentifier:
            ...
            Ue.hasQuotes
              ? (this._writeContent('"'),
                this._writeContent(Ue.identifier),
                this._writeContent('"'))
              : this._writeContent(Ue.identifier)
            break
          case g.MemberReference:
            var fe = e
            ;(fe.hasDot && this._writeContent('.'),
              fe.selector && this._writeContent('('),
              fe.memberSymbol
                ? this._renderNode(fe.memberSymbol)
                : this._renderNode(fe.memberIdentifier),
              fe.selector &&
                (this._writeContent(':'),
                this._renderNode(fe.selector),
                this._writeContent(')')))
            break
          case g.MemberSelector:
            var yn = e
            this._writeContent(yn.selector)
            break
          case g.MemberSymbol:
            var Nt = e
            ;(this._writeContent('['),
              this._renderNode(Nt.symbolReference),
              this._writeContent(']'))
            break
          case g.Section:
            var jn = e
            this._renderNodes(jn.nodes)
            break
          case g.Paragraph:
            var mt = Bn.trimSpacesInParagraph(e)
            mt.nodes.length > 0 &&
              (this._hangingParagraph
                ? (this._hangingParagraph = !1)
                : this._ensureLineSkipped(),
              this._renderNodes(mt.nodes),
              this._writeNewline())
            break
          case g.ParamBlock:
            var A = e
            ;(this._ensureLineSkipped(),
              this._renderNode(A.blockTag),
              this._writeContent(' '),
              this._writeContent(A.parameterName),
              this._writeContent(' - '),
              (this._hangingParagraph = !0),
              this._renderNode(A.content),
              (this._hangingParagraph = !1))
            break
          case g.ParamCollection:
            var k = e
            this._renderNodes(k.blocks)
            break
          case g.PlainText:
            var f = e
    ...
    (r.prototype._renderInlineTag = function (e, t) {
      ;(this._writeContent('{'),
        this._writeContent(e.tagName),
        t(),
        this._writeContent('}'))
    }),
    (r.prototype._renderNodes = function (e) {
      for (var t = 0, n = e; t < n.length; t++) {
        var i = n[t]
        this._renderNode(i)
      }
    }),
    (r.prototype._ensureAtStartOfLine = function () {
      this._lineState === ee.MiddleOfLine && this._writeNewline()
    }),
    (r.prototype._ensureLineSkipped = function () {
      ;(this._ensureAtStartOfLine(),
        this._previousLineHadContent && this._writeNewline())
    }),
    (r.prototype._writeContent = function (e) {
      if (!(e === void 0 || e.length === 0)) {
        var t = e.split(/\r?\n/g)
        if (t.length > 1) {
          for (var n = !0, i = 0, o = t; i < o.length; i++) {
            var a = o[i]
            ;(n ? (n = !1) : this._writeNewline(), this._writeContent(a))
          }
          return
        }
        ;(this._lineState === ee.Closed &&
          ...
          (this._lineState = ee.StartOfLine)),
          this._lineState === ee.StartOfLine &&
            this._emitCommentFraming &&
            this._output.append(' '),
          this._output.append(e),
          (this._lineState = ee.MiddleOfLine),
          (this._previousLineHadContent = !0))
      }
    }),
    (r.prototype._writeNewline = function () {
      ;(this._lineState === ee.Closed &&
        (this._emitCommentFraming &&
          this._output.append('/**' + this.eol + ' *'),
        (this._lineState = ee.StartOfLine)),
        (this._previousLineHadContent = this._lineState === ee.MiddleOfLine),
        this._emitCommentFraming
          ? this._output.append(this.eol + ' *')
          : this._output.append(this.eol),
        (this._lineState = ee.StartOfLine),
    ...
    (r.prototype._writeEnd = function () {
      ;(this._lineState === ee.MiddleOfLine &&
        this._emitCommentFraming &&
        this._writeNewline(),
        this._lineState !== ee.Closed &&
...
var co = (function () {
  ...
  Ut = (function (r) {
    ...
    function e(t) {
      var n = r.call(this, t) || this
      return (
        (n.summarySection = new Oe({ configuration: n.configuration })),
        (n.remarksBlock = void 0),
        (n.privateRemarks = void 0),
        (n.deprecatedBlock = void 0),
        (n.params = new jt({ configuration: n.configuration })),
        (n.typeParams = new jt({ configuration: n.configuration })),
        (n.returnsBlock = void 0),
        (n.modifierTagSet = new In()),
        (n._seeBlocks = []),
        (n._customBlocks = []),
        n
      )
    ...
    return (
      ...
      (e.prototype.emitAsTsdoc = function () {
        var t = new Se(),
          n = new Ce()
        return (n.renderComment(t, this), t.toString())
      }),
      e
    )
  })(v)
  ...
  Yt = (function (r) {
    ...
    function e(t) {
      ...
      return (
        ...
        (i._memberReferences = []),
        t.memberReferences &&
          (n = i._memberReferences).push.apply(n, t.memberReferences),
        i
      )
    }
    return (
      ...
      (e.prototype.emitAsTsdoc = function () {
        var t = new Se(),
          n = new Ce()
        return (n.renderDeclarationReference(t, this), t.toString())
      }),
      (e.prototype.onGetChildNodes = function () {
        return uo(
          [
...
var po = (function () {
  ...
  Ve = (function (r) {
    ...
    function e(t) {
      var n = r.call(this, t) || this
      return (
        (n._textExcerpt = new y({
          configuration: n.configuration,
          excerptKind: x.ErrorText,
          content: t.textExcerpt,
        })),
        (n._messageId = t.messageId),
        (n._errorMessage = t.errorMessage),
        (n._errorLocation = t.errorLocation),
        n
      )
    }
    return (
...
var fo = (function () {
  ...
  on
;(function (r) {
  r[(r.CommonMarkBackslash = 0)] = 'CommonMarkBackslash'
})(on || (on = {}))
var Rt = (function (r) {
  fo(e, r)
  function e(t) {
    var n = r.call(this, t) || this
    return (
      (n._escapeStyle = t.escapeStyle),
      (n._encodedTextExcerpt = new y({
        configuration: n.configuration,
        excerptKind: x.EscapedText,
        content: t.encodedTextExcerpt,
      })),
      (n._decodedText = t.decodedText),
      n
    )
  }
  return (
  ...
  zt = (function (r) {
    ...
    return (
      ...
      (e.prototype.emitAsHtml = function () {
        var t = new Se(),
          n = new Ce()
        return (n.renderHtmlTag(t, this), t.toString())
      }),
      (e.prototype.onGetChildNodes = function () {
        return [
          this._openingDelimiterExcerpt,
...
var Ao = (function () {
  ...
  Jt = (function (r) {
    ...
    function e(t) {
      ...
      return (
        v.isParsedParameters(t)
          ? ((i._openingDelimiterExcerpt = new y({
              configuration: i.configuration,
              excerptKind: x.HtmlStartTag_OpeningDelimiter,
              content: t.openingDelimiterExcerpt,
            })),
            (i._nameExcerpt = new y({
              configuration: i.configuration,
              excerptKind: x.HtmlStartTag_Name,
              content: t.nameExcerpt,
            })),
            t.spacingAfterNameExcerpt &&
              (i._spacingAfterNameExcerpt = new y({
                configuration: i.configuration,
                excerptKind: x.Spacing,
                content: t.spacingAfterNameExcerpt,
              })),
            (i._closingDelimiterExcerpt = new y({
              configuration: i.configuration,
        ...
        (i._htmlAttributes = []),
        t.htmlAttributes &&
          (n = i._htmlAttributes).push.apply(n, t.htmlAttributes),
      ...
      return (
        ...
        v.isParsedParameters(t) &&
          ...
          t.spacingAfterTagNameExcerpt &&
            (n._spacingAfterTagNameExcerpt = new y({
              configuration: n.configuration,
              excerptKind: x.Spacing,
...
var xo = (function () {
  ...
  wt = (function (r) {
    ...
    function e(t) {
      var n = r.call(this, t) || this
      if (n.tagNameWithUpperCase !== '@INHERITDOC')
        throw new Error(
          'DocInheritDocTag requires the tag name to be "{@inheritDoc}"',
        )
      return ((n._declarationReference = t.declarationReference), n)
    }
    return (
      Object.defineProperty(e.prototype, 'kind', {
        get: function () {
...
var jo = (function () {
  ...
  Wt = (function (r) {
    ...
    function e(t) {
      var n = r.call(this, t) || this
      if (n.tagNameWithUpperCase !== '@LINK')
        throw new Error('DocLinkTag requires the tag name to be "{@link}"')
      if (((n._codeDestination = t.codeDestination), v.isParsedParameters(t))) {
        ...
        ;((n._urlDestination = t.urlDestination), (n._linkText = t.linkText))
      }
      return n
    }
    return (
...
var Xt = (function (r) {
  ...
  function e(t) {
    ...
    return (
      v.isParsedParameters(t)
        ? ((n._selectorExcerpt = new y({
            configuration: n.configuration,
            excerptKind: x.MemberSelector,
            content: t.selectorExcerpt,
          })),
          (n._selector = t.selectorExcerpt.toString()))
        : (n._selector = t.selector),
      (n._selectorKind = st.Error),
      (n._errorMessage = void 0),
      n._selector.length === 0
        ? (n._errorMessage = 'The selector cannot be an empty string')
        : e._likeIndexSelectorRegExp.test(n._selector)
          ? e._indexSelectorRegExp.test(n._selector)
            ? (n._selectorKind = st.Index)
            : (n._errorMessage =
                'If the selector begins with a number, it must be a positive integer value')
          : e._likeLabelSelectorRegExp.test(n._selector)
            ? e._labelSelectorRegExp.test(n._selector)
              ? (n._selectorKind = st.Label)
              : (n._errorMessage =
                  'A label selector must be comprised of upper case letters, numbers, and underscores and must not start with a number')
            : J.isSystemSelector(n._selector)
              ? (n._selectorKind = st.System)
              : e._likeSystemSelectorRegExp.test(n._selector)
                ? (n._errorMessage =
                    'The selector '.concat(JSON.stringify(n._selector)) +
                    ' is not a recognized TSDoc system selector name')
                : (n._errorMessage = 'Invalid syntax for selector'),
      n
    )
  }
  return (
...
var Eo = (function () {
  ...
  Tt = (function (r) {
    ...
    function e(t) {
      var n = r.call(this, t) || this
      return (
        (n._parameterName = t.parameterName),
        v.isParsedParameters(t) &&
          (t.spacingBeforeParameterNameExcerpt &&
            (n._spacingBeforeParameterNameExcerpt = new y({
              configuration: n.configuration,
              excerptKind: x.Spacing,
              content: t.spacingBeforeParameterNameExcerpt,
            })),
          t.unsupportedJsdocTypeBeforeParameterNameExcerpt &&
            (n._unsupportedJsdocTypeBeforeParameterNameExcerpt = new y({
              configuration: n.configuration,
...
var an = (function () {
  function r() {}
  return (
    (r.hasAnyTextContent = function (e, t) {
      ;(t === void 0 || t < 1) && (t = 1)
      var n
      e instanceof v ? (n = [e]) : (n = e)
      var i = r._scanTextContent(n, t, 0)
      return i >= t
    }),
    (r._scanTextContent = function (e, t, n) {
      for (var i = 0, o = e; i < o.length; i++) {
        var a = o[i]
        switch (a.kind) {
          case g.FencedCode:
            var l = a
            n += r._countNonSpaceCharacters(l.code)
            break
          case g.CodeSpan:
            var u = a
            n += r._countNonSpaceCharacters(u.code)
            break
          case g.EscapedText:
            var d = a
            n += r._countNonSpaceCharacters(d.decodedText)
            break
          case g.LinkTag:
            var h = a
            n += r._countNonSpaceCharacters(h.linkText || '')
            break
          case g.PlainText:
            var j = a
            n += r._countNonSpaceCharacters(j.text)
            break
        }
        if (
          n >= t ||
    ...
    (r._countNonSpaceCharacters = function (e) {
      for (var t = 0, n = e.length, i = 0; i < n; ) {
...
var ye = (function () {
  function r(e, t, n) {
    ;((this.buffer = e), (this.pos = t), (this.end = n), this._validateBounds())
  }
  return (
    (r.fromString = function (e) {
      return new r(e, 0, e.length)
    }),
    (r.fromStringRange = function (e, t, n) {
      return new r(e, t, n)
    }),
    ...
    (r.prototype.getNewRange = function (e, t) {
      return new r(this.buffer, e, t)
    }),
    ...
    (r.prototype.getDebugDump = function (e, t) {
      return (
    ...
    (r.prototype.getLocation = function (e) {
      if (e < 0 || e > this.buffer.length) return { line: 0, column: 0 }
      for (var t = 1, n = 1, i = 0; i < e; ) {
        var o = this.buffer[i]
        ;(++i,
          o !== '\r' &&
            (o ===
...
`
    ...
    (r.prototype._validateBounds = function () {
...
var bt = (function () {
  ...
  return (
    (r._formatMessageText = function (e, t) {
      if (
        (e || (e = 'An unknown error occurred'), t.pos !== 0 || t.end !== 0)
      ) {
        var n = t.getLocation(t.pos)
        if (n.line) return '('.concat(n.line, ',').concat(n.column, '): ') + e
      }
      return e
    }),
    Object.defineProperty(r.prototype, 'text', {
      get: function () {
        return (
          this._text === void 0 &&
            (this._text = r._formatMessageText(
...
var qn = (function () {
  ...
  return (
    Object.defineProperty(r.prototype, 'messages', {
      get: function () {
    ...
    (r.prototype.addMessage = function (e) {
      this._messages.push(e)
    }),
    (r.prototype.addMessageForTextRange = function (e, t, n) {
      this.addMessage(new bt({ messageId: e, messageText: t, textRange: n }))
    }),
    (r.prototype.addMessageForTokenSequence = function (e, t, n, i) {
      this.addMessage(
        new bt({
          messageId: e,
          messageText: t,
          textRange: n.getContainingTextRange(),
          tokenSequence: n,
          docNode: i,
        }),
      )
    }),
    (r.prototype.addMessageForDocErrorText = function (e) {
      var t
...
var Ln = (function () {
  function r(e, t) {
    ;((this.commentRange = ye.empty),
      (this.lines = []),
      (this.tokens = []),
      (this.configuration = e),
      (this.sourceRange = t),
      (this.docComment = new Ut({ configuration: this.configuration })),
      (this.log = new qn()))
  }
  return r
})()
var qe = (function () {
  ...
  return (
    (r.createEmpty = function (e) {
      return new r({ parserContext: e, startIndex: 0, endIndex: 0 })
    }),
    Object.defineProperty(r.prototype, 'startIndex', {
      get: function () {
    ...
    Object.defineProperty(r.prototype, 'endIndex', {
      get: function () {
    ...
    Object.defineProperty(r.prototype, 'tokens', {
      get: function () {
    ...
    (r.prototype.getNewSequence = function (e, t) {
      return new r({
    ...
    (r.prototype.getContainingTextRange = function () {
      return this.isEmpty()
        ? ye.empty
...
var Q
;(function (r) {
  ;((r[(r.BeginComment1 = 0)] = 'BeginComment1'),
    (r[(r.BeginComment2 = 1)] = 'BeginComment2'),
    (r[(r.CollectingFirstLine = 2)] = 'CollectingFirstLine'),
    (r[(r.CollectingLine = 3)] = 'CollectingLine'),
    (r[(r.AdvancingLine = 4)] = 'AdvancingLine'),
    (r[(r.Done = 5)] = 'Done'))
})(Q || (Q = {}))
var Vr = (function () {
  function r() {}
  return (
    (r.extract = function (e) {
      for (
        ...
        if (u >= t.end)
          switch (d) {
            case Q.BeginComment1:
            case Q.BeginComment2:
              return (
            ...
            default:
              return (
                e.log.addMessageForTextRange(
                  w.CommentMissingClosingDelimiter,
        ...
        switch (d) {
          case Q.BeginComment1:
            if (j === '/' && M === '*') ((i = E), ++u, (d = Q.BeginComment2))
            else if (!r._whitespaceCharacterRegExp.test(j))
              return (
                e.log.addMessageForTextRange(
                  w.CommentOpeningDelimiterSyntax,
                  'Expecting a leading "/**"',
                  t.getNewRange(E, E + 1),
                ),
                !1
          ...
          case Q.BeginComment2:
            if (j === '*')
              (M === ' ' && ++u, (a = u), (l = u), (d = Q.CollectingFirstLine))
            else
              return (
                e.log.addMessageForTextRange(
                  w.CommentOpeningDelimiterSyntax,
            ...
            break
          case Q.CollectingFirstLine:
          case Q.CollectingLine:
            j ===
            `
`
              ? ((d !== Q.CollectingFirstLine || l > a) &&
                  h.push(t.getNewRange(a, l)),
                (a = u),
                (l = u),
                (d = Q.AdvancingLine))
              : j === '*' && M === '/'
                ? (l > a && h.push(t.getNewRange(a, l)),
                  (a = 0),
                  (l = 0),
                  ++u,
                  (o = u),
                  (d = Q.Done))
                : r._whitespaceCharacterRegExp.test(j) || (l = u)
            break
          case Q.AdvancingLine:
            j === '*'
              ? M === '/'
                ? ((a = 0), (l = 0), ++u, (o = u), (d = Q.Done))
                : (M === ' ' && ++u, (a = u), (l = u), (d = Q.CollectingLine))
              : j ===
                  `
`
                ? (h.push(t.getNewRange(E, E)), (a = u))
                : r._whitespaceCharacterRegExp.test(j) ||
                  ((l = u), (d = Q.CollectingLine))
            break
        }
      }
      return ((e.commentRange = t.getNewRange(i, o)), (e.lines = h), !0)
    }),
    (r._whitespaceCharacterRegExp = /^\s$/),
    r
  )
})()
var Et = (function () {
  function r() {}
  return (
    (r.readTokens = function (e) {
      r._ensureInitialized()
      for (var t = [], n = void 0, i = 0, o = e; i < o.length; i++) {
        var a = o[i]
        ;(r._pushTokensForLine(t, a), (n = a))
      }
      return (
        n
          ? t.push(new ze(p.EndOfInput, n.getNewRange(n.end, n.end), n))
          : t.push(new ze(p.EndOfInput, ye.empty, ye.empty)),
        t
      )
    }),
    (r.isPunctuation = function (e) {
      return (r._ensureInitialized(), r._punctuationTokens[e] || !1)
    }),
    (r._pushTokensForLine = function (e, t) {
      for (var n = t.buffer, i = t.end, o = t.pos, a = void 0, l = o; o < i; ) {
        var u = n.charCodeAt(o),
          d = r._charCodeMap[u]
        ;(d === void 0 && (d = p.Other),
          (a !== void 0 && d === a && r._isMultiCharacterToken(a)) ||
            (a !== void 0 && e.push(new ze(a, t.getNewRange(l, o), t)),
            (l = o),
            (a = d)),
          ++o)
      }
      ;(a !== void 0 && e.push(new ze(a, t.getNewRange(l, o), t)),
        e.push(new ze(p.Newline, t.getNewRange(t.end, t.end), t)))
    }),
    (r._isMultiCharacterToken = function (e) {
      switch (e) {
        case p.Spacing:
        case p.AsciiWord:
        case p.Other:
    ...
    (r._ensureInitialized = function () {
      if (!r._charCodeMap) {
        ;((r._charCodeMap = {}), (r._punctuationTokens = {}))
        for (
          var e = r._commonMarkPunctuationCharacters, t = 0;
          t < e.length;
          ++t
        ) {
          var n = e.charCodeAt(t)
          r._charCodeMap[n] = p.OtherPunctuation
        }
        for (
          var i = {
              '\\': p.Backslash,
          ...
          var l = a[o]
          ;((r._charCodeMap[l.charCodeAt(0)] = i[l]),
            (r._punctuationTokens[i[l]] = !0))
        }
        r._punctuationTokens[p.OtherPunctuation] = !0
        for (var u = r._wordCharacters, t = 0; t < u.length; ++t) {
          var n = u.charCodeAt(t)
          r._charCodeMap[n] = p.AsciiWord
        }
        ;((r._charCodeMap[' '.charCodeAt(0)] = p.Spacing),
          (r._charCodeMap['	'.charCodeAt(0)] = p.Spacing))
      }
    }),
    (r._commonMarkPunctuationCharacters = '!"#$%&\'()*+,-./:;<=>?@[\\]^`{|}~'),
    (r._wordCharacters =
...
var $n = (function () {
  ...
  return (
    (r.prototype.extractAccumulatedSequence = function () {
    ...
    (r.prototype.isAccumulatedSequenceEmpty = function () {
      return this._accumulatedStartIndex === this._currentIndex
    }),
    (r.prototype.tryExtractAccumulatedSequence = function () {
      if (!this.isAccumulatedSequenceEmpty())
        return this.extractAccumulatedSequence()
    }),
    (r.prototype.assertAccumulatedSequenceIsEmpty = function () {
      if (!this.isAccumulatedSequenceEmpty()) {
        var e = new qe({
            parserContext: this._parserContext,
            startIndex: this._accumulatedStartIndex,
...
` + JSON.stringify(t),
    ...
    (r.prototype.readToken = function () {
      ...
      if (e.kind === p.EndOfInput)
        throw new Error('The EndOfInput token cannot be read')
      return (this._currentIndex++, e)
    }),
    (r.prototype.peekPreviousTokenKind = function () {
      return this._currentIndex === 0
        ? p.EndOfInput
        : this.tokens[this._currentIndex - 1].kind
    }),
    (r.prototype.createMarker = function () {
      return this._currentIndex
    }),
    (r.prototype.backtrackToMarker = function (e) {
...
function kt(r) {
  return r !== void 0 && Object.hasOwnProperty.call(r, 'failureMessage')
}
var zr = (function () {
  function r(e) {
  ...
  return (
    (r.prototype.parse = function () {
      for (var e = new $n(this._parserContext), t = !1; !t; )
        switch (e.peekTokenKind()) {
          ...
          case p.AtSign:
            ...
            break
          case p.LeftCurlyBracket: {
            this._pushAccumulatedPlainText(e)
            var n = e.createMarker(),
          ...
          case p.Backtick:
            ;(this._pushAccumulatedPlainText(e),
              e.peekTokenAfterKind() === p.Backtick &&
              e.peekTokenAfterAfterKind() === p.Backtick
    ...
    (r.prototype._performValidationChecks = function () {
      var e = this._parserContext.docComment
      ;(e.deprecatedBlock &&
        (an.hasAnyTextContent(e.deprecatedBlock) ||
        ...
        e.inheritDocTag &&
          ...
          an.hasAnyTextContent(e.summarySection) &&
            this._parserContext.log.addMessageForTextRange(
              w.InheritDocIncompatibleSummary,
    ...
    (r.prototype._validateTagDefinition = function (e, t, n, i, o) {
      if (e) {
        var a = e.syntaxKind === F.InlineTag
        a !== n
          ? n
            ? this._parserContext.log.addMessageForTokenSequence(
                w.TagShouldNotHaveBraces,
    ...
    (r.prototype._pushAccumulatedPlainText = function (e) {
    ...
    (r.prototype._parseAndPushBlock = function (e) {
      var t = this._parserContext.docComment,
        n = this._parserContext.configuration,
        i = t.modifierTagSet,
      ...
      var a = o,
        l = n.tryGetTagDefinitionWithUpperCase(a.tagNameWithUpperCase)
      if (
        ...
        switch (l.syntaxKind) {
          case F.BlockTag:
            if (a.tagNameWithUpperCase === L.param.tagNameWithUpperCase) {
              var u = this._parseParamBlock(e, a, L.param.tagName)
              ;(this._parserContext.docComment.params.add(u),
                (this._currentSection = u.content))
              return
            } else if (
              a.tagNameWithUpperCase === L.typeParam.tagNameWithUpperCase
            ) {
              var u = this._parseParamBlock(e, a, L.typeParam.tagName)
              ;(this._parserContext.docComment.typeParams.add(u),
                (this._currentSection = u.content))
              return
            } else {
              var d = new it({
    ...
    (r.prototype._addBlockToDocComment = function (e) {
      var t = this._parserContext.docComment
      switch (e.blockTag.tagNameWithUpperCase) {
        case L.remarks.tagNameWithUpperCase:
          t.remarksBlock = e
          break
        case L.privateRemarks.tagNameWithUpperCase:
          t.privateRemarks = e
          break
        case L.deprecated.tagNameWithUpperCase:
          t.deprecatedBlock = e
          break
        case L.returns.tagNameWithUpperCase:
          t.returnsBlock = e
          break
        case L.see.tagNameWithUpperCase:
          t._appendSeeBlock(e)
          break
        default:
    ...
    (r.prototype._tryParseJSDocTypeOrValueRest = function (e, t, n, i) {
      for (var o, a = 1; a > 0; ) {
    ...
    (r.prototype._tryParseUnsupportedJSDocType = function (e, t, n) {
      if (
        (e.assertAccumulatedSequenceIsEmpty(),
        !(
          e.peekTokenKind() !== p.LeftCurlyBracket ||
          e.peekTokenAfterKind() === p.AtSign
        ))
      ) {
        ...
        if (o) {
          this._parserContext.log.addMessageForTokenSequence(
            w.ParamTagWithInvalidType,
            'The ' + n + " block should not include a JSDoc-style '{type}'",
            o,
            t,
          )
    ...
    (r.prototype._tryParseJSDocOptionalNameRest = function (e) {
      if (
        (e.assertAccumulatedSequenceIsEmpty(),
        e.peekTokenKind() !== p.EndOfInput)
      ) {
    ...
    (r.prototype._parseParamBlock = function (e, t, n) {
      var i = e.createMarker(),
        o = this._tryReadSpacingAndNewlines(e),
        a = this._tryParseUnsupportedJSDocType(e, t, n),
        l
      e.peekTokenKind() === p.LeftSquareBracket &&
      ...
      var h = J.explainIfInvalidUnquotedIdentifier(u)
      if (h !== void 0) {
        e.backtrackToMarker(i)
        var j = new Tt({
            configuration: this._configuration,
          ...
          E =
            u.length > 0
              ? 'The ' +
                ...
                h
              : 'The ' + n + ' block should be followed by a parameter name'
        return (
          this._parserContext.log.addMessageForTokenSequence(
            w.ParamTagWithInvalidName,
            E,
            t.getTokenSequence(),
            t,
          ),
      ...
      var M = e.extractAccumulatedSequence(),
        I
      if (l) {
        I = this._tryParseJSDocOptionalNameRest(e)
        var K = l
        ;(I &&
          (K = t.getTokenSequence().getNewSequence(l.startIndex, I.endIndex)),
          this._parserContext.log.addMessageForTokenSequence(
            w.ParamTagWithInvalidOptionalName,
            'The ' +
              n +
      ...
      var D = this._tryReadSpacingAndNewlines(e),
        R = this._tryParseUnsupportedJSDocType(e, t, n),
        oe,
        ae,
        W
      return (
        e.peekTokenKind() === p.Hyphen
          ? (e.readToken(),
            (oe = e.extractAccumulatedSequence()),
            (ae = this._tryReadSpacingAndNewlines(e)),
            (W = this._tryParseUnsupportedJSDocType(e, t, n)))
          : this._parserContext.log.addMessageForTokenSequence(
              w.ParamTagMissingHyphen,
              'The ' +
                n +
        ...
        new Tt({
          ...
          parameterNameExcerpt: M,
          parameterName: u,
          unsupportedJsdocOptionalNameRestExcerpt: I,
          spacingAfterParameterNameExcerpt: D,
          unsupportedJsdocTypeAfterParameterNameExcerpt: R,
          hyphenExcerpt: oe,
          spacingAfterHyphenExcerpt: ae,
          unsupportedJsdocTypeAfterHyphenExcerpt: W,
        })
      )
    }),
    (r.prototype._pushNode = function (e) {
    ...
    (r.prototype._parseBackslashEscape = function (e) {
      e.assertAccumulatedSequenceIsEmpty()
      var t = e.createMarker()
      if ((e.readToken(), e.peekTokenKind() === p.EndOfInput))
        return this._backtrackAndCreateError(
          e,
          t,
          w.UnnecessaryBackslash,
          'A backslash must precede another character that is being escaped',
        )
      var n = e.readToken()
      if (!Et.isPunctuation(n.kind))
        return this._backtrackAndCreateError(
          e,
          t,
          w.UnnecessaryBackslash,
      ...
      return new Rt({
        parsed: !0,
        configuration: this._configuration,
        escapeStyle: on.CommonMarkBackslash,
        encodedTextExcerpt: i,
        decodedText: n.toString(),
      })
    }),
    (r.prototype._parseBlockTag = function (e) {
      e.assertAccumulatedSequenceIsEmpty()
      var t = e.createMarker()
      if (e.peekTokenKind() !== p.AtSign)
        return this._backtrackAndCreateError(
          e,
          t,
          w.MissingTag,
      ...
      var n = e.readToken().toString()
      if (e.peekTokenKind() !== p.AsciiWord)
        return this._backtrackAndCreateError(
          e,
          t,
          w.AtSignWithoutTagName,
          'Expecting a TSDoc tag name after "@"; if it is not a tag, use a backslash to escape this character',
        )
      for (var i = e.createMarker(); e.peekTokenKind() === p.AsciiWord; )
        n += e.readToken().toString()
      switch (e.peekTokenKind()) {
        case p.Spacing:
        case p.Newline:
        case p.EndOfInput:
      ...
      if (J.explainIfInvalidTSDocTagName(n)) {
    ...
    (r.prototype._parseInlineTag = function (e) {
      e.assertAccumulatedSequenceIsEmpty()
      var t = e.createMarker()
      if (e.peekTokenKind() !== p.LeftCurlyBracket)
        return this._backtrackAndCreateError(
          e,
          t,
          w.MissingTag,
      ...
      e.readToken()
      var n = e.extractAccumulatedSequence(),
        i = e.createMarker()
      if (e.peekTokenKind() !== p.AtSign)
        return this._backtrackAndCreateError(
          e,
          t,
          w.MalformedInlineTag,
          'Expecting a TSDoc tag starting with "{@"',
        )
      for (
        var o = e.readToken().toString();
        e.peekTokenKind() === p.AsciiWord;
      )
      ...
      if (J.explainIfInvalidTSDocTagName(o)) {
        var a = this._createFailureForTokensSince(
          e,
          w.MalformedTagName,
          'A TSDoc tag name must start with a letter and contain only letters and numbers',
      ...
      var l = e.extractAccumulatedSequence(),
        u = this._tryReadSpacingAndNewlines(e)
      if (u === void 0 && e.peekTokenKind() !== p.RightCurlyBracket) {
        var d = e.peekToken().range.toString()[0],
          a = this._createFailureForToken(
            e,
            w.CharactersAfterInlineTag,
        ...
        switch (e.peekTokenKind()) {
          case p.EndOfInput:
            return this._backtrackAndCreateErrorRange(
              ...
              t,
              i,
              w.InlineTagMissingRightBrace,
              'The TSDoc inline tag name is missing its closing "}"',
            )
          case p.Backslash:
            if ((e.readToken(), !Et.isPunctuation(e.peekTokenKind()))) {
      ...
      var j = e.tryExtractAccumulatedSequence()
      e.readToken()
      var E = e.extractAccumulatedSequence(),
        M = {
          parsed: !0,
          configuration: this._configuration,
          openingDelimiterExcerpt: n,
          tagNameExcerpt: l,
          tagName: o,
          spacingAfterTagNameExcerpt: u,
          tagContentExcerpt: j,
          closingDelimiterExcerpt: E,
        },
        I = o.toUpperCase(),
        K = new $n(
          this._parserContext,
          j || qe.createEmpty(this._parserContext),
        ),
        D
      switch (I) {
        case L.inheritDoc.tagNameWithUpperCase:
          D = this._parseInheritDocTag(M, K)
          break
        case L.link.tagNameWithUpperCase:
          D = this._parseLinkTag(M, K)
          break
        default:
          D = new ot(M)
      }
      var R =
        this._parserContext.configuration.tryGetTagDefinitionWithUpperCase(I)
      return (this._validateTagDefinition(R, o, !0, l, D), D)
    }),
    (r.prototype._parseInheritDocTag = function (e, t) {
      var n = new ot(e),
        i = sn({}, e)
      if (t.peekTokenKind() !== p.EndOfInput) {
        if (
    ...
    (r.prototype._parseLinkTag = function (e, t) {
      var n = new ot(e),
        i = sn({}, e)
      ...
      for (
        var o =
            t.peekTokenKind() === p.Slash && t.peekTokenAfterKind() === p.Slash,
          a = t.createMarker(),
          l = o;
        !l;
      )
        switch (t.peekTokenKind()) {
          ...
          case p.Colon:
            ;(t.readToken(),
              (o =
                t.peekTokenKind() === p.Slash &&
                t.peekTokenAfterKind() === p.Slash),
              (l = !0))
            break
          default:
            l = !0
      ...
      if ((t.backtrackToMarker(a), o)) {
        if (!this._parseLinkTagUrlDestination(t, i, e.tagNameExcerpt, n))
          return n
      } else if (!this._parseLinkTagCodeDestination(t, i, e.tagNameExcerpt, n))
        return n
      if (t.peekTokenKind() === p.Spacing)
        throw new Error('Unconsumed spacing encountered after construct')
      if (t.peekTokenKind() === p.Pipe) {
        ;(t.readToken(),
        ...
        for (var u = void 0; !l; )
          switch (t.peekTokenKind()) {
            ...
            case p.Newline:
              ...
              break
            default:
              ;((u = t.createMarker() + 1), t.readToken())
          }
        var h = t.tryExtractAccumulatedSequence()
        h &&
          (u === void 0
            ? (i.spacingAfterLinkTextExcerpt = h)
            : u >= h.endIndex
              ? (i.linkTextExcerpt = h)
              : ((i.linkTextExcerpt = h.getNewSequence(h.startIndex, u)),
                (i.spacingAfterLinkTextExcerpt = h.getNewSequence(
                  u,
                  h.endIndex,
                ))))
      } else if (t.peekTokenKind() !== p.EndOfInput)
        return (
          t.readToken(),
          this._parserContext.log.addMessageForTokenSequence(
            w.LinkTagDestinationSyntax,
    ...
    (r.prototype._parseLinkTagUrlDestination = function (e, t, n, i) {
      for (var o = '', a = !1; !a; )
        switch (e.peekTokenKind()) {
          case p.Spacing:
          case p.Newline:
    ...
    (r.prototype._parseLinkTagCodeDestination = function (e, t, n, i) {
      return (
        (t.codeDestination = this._parseDeclarationReference(e, n, i)),
        !!t.codeDestination
      )
    }),
    (r.prototype._parseDeclarationReference = function (e, t, n) {
      e.assertAccumulatedSequenceIsEmpty()
      for (var i = e.createMarker(), o = !1, a = !0, l = !1, u = !1; !u; )
        switch (e.peekTokenKind()) {
          case p.DoubleQuote:
          case p.EndOfInput:
          case p.LeftCurlyBracket:
      ...
      var d, h, j, E
      if (o) {
        if (e.peekTokenKind() !== p.Period) {
          var M = e.peekTokenKind() === p.AtSign,
            I = !1
          for (u = !1; !u; )
            switch (e.peekTokenKind()) {
              case p.EndOfInput:
          ...
          if (!e.isAccumulatedSequenceEmpty()) {
            ...
            var K = J.explainIfInvalidPackageName(d.toString())
            if (K) {
              this._parserContext.log.addMessageForTokenSequence(
                w.ReferenceMalformedPackageName,
                K,
                d,
                n,
              )
        ...
        if (!e.isAccumulatedSequenceEmpty()) {
          h = e.extractAccumulatedSequence()
          var K = J.explainIfInvalidImportPath(h.toString(), !!d)
          if (K) {
            this._parserContext.log.addMessageForTokenSequence(
              w.ReferenceMalformedImportPath,
              K,
              h,
              n,
            )
        ...
        if (e.peekTokenKind() !== p.PoundSymbol)
          throw new Error('Expecting pound symbol')
        if (
          (e.readToken(),
          (j = e.extractAccumulatedSequence()),
          (E = this._tryReadSpacingAndNewlines(e)),
          d === void 0 && h === void 0)
        ) {
          this._parserContext.log.addMessageForTokenSequence(
            w.ReferenceHashSyntax,
      ...
      for (u = !1; !u; )
        switch (e.peekTokenKind()) {
          ...
          case p.DoubleQuote:
            var R = D.length > 0,
              oe = this._parseMemberReference(e, R, t, n)
            if (!oe) return
            D.push(oe)
            break
          default:
      ...
      if (d === void 0 && h === void 0 && D.length === 0) {
        this._parserContext.log.addMessageForTokenSequence(
          w.MissingReference,
      ...
      return new Yt({
        ...
        importPathExcerpt: h,
        importHashExcerpt: j,
        spacingAfterImportHashExcerpt: E,
        memberReferences: D,
      })
    }),
    (r.prototype._parseMemberReference = function (e, t, n, i) {
      var o = { parsed: !0, configuration: this._configuration }
      if (t) {
        if (e.peekTokenKind() !== p.Period) {
          this._parserContext.log.addMessageForTokenSequence(
            w.ReferenceMissingDot,
      ...
      if (
        (e.peekTokenKind() === p.LeftParenthesis &&
          (e.readToken(),
        ...
        ((o.memberIdentifier = this._parseMemberIdentifier(e, n, i)),
        !o.memberIdentifier)
      )
        return
      if (
        ((o.spacingAfterMemberExcerpt = this._tryReadSpacingAndNewlines(e)),
        e.peekTokenKind() === p.Colon)
      ) {
        if (
          (e.readToken(),
          ...
          this._parserContext.log.addMessageForTokenSequence(
            w.ReferenceSelectorMissingParens,
      ...
      if (o.leftParenthesisExcerpt) {
        if (e.peekTokenKind() !== p.RightParenthesis) {
          this._parserContext.log.addMessageForTokenSequence(
            w.ReferenceMissingRightParen,
    ...
    (r.prototype._parseMemberSymbol = function (e, t) {
      if (e.peekTokenKind() !== p.LeftSquareBracket)
        throw new Error('Expecting "["')
      e.readToken()
      var n = e.extractAccumulatedSequence(),
        i = this._tryReadSpacingAndNewlines(e),
        o = this._parseDeclarationReference(e, n, t)
      if (!o) {
        this._parserContext.log.addMessageForTokenSequence(
          w.ReferenceSymbolSyntax,
      ...
      if (e.peekTokenKind() !== p.RightSquareBracket) {
        this._parserContext.log.addMessageForTokenSequence(
          w.ReferenceMissingRightBracket,
      ...
      return new Zt({
        parsed: !0,
        configuration: this._configuration,
        leftBracketExcerpt: n,
        spacingAfterLeftBracketExcerpt: i,
        symbolReference: o,
        rightBracketExcerpt: a,
      })
    }),
    (r.prototype._parseMemberIdentifier = function (e, t, n) {
      var i = void 0,
        o = void 0
      if (e.peekTokenKind() === p.DoubleQuote) {
        for (
          e.readToken(), i = e.extractAccumulatedSequence();
          e.peekTokenKind() !== p.DoubleQuote;
        ) {
          if (e.peekTokenKind() === p.EndOfInput) {
            this._parserContext.log.addMessageForTokenSequence(
        ...
        var a = e.extractAccumulatedSequence(),
          u = a.toString(),
          d = J.explainIfInvalidUnquotedMemberIdentifier(u)
        if (d) {
          this._parserContext.log.addMessageForTokenSequence(
            w.ReferenceUnquotedIdentifier,
            d,
            a,
            n,
          )
    ...
    (r.prototype._parseMemberSelector = function (e, t, n) {
      e.peekTokenKind() !== p.AsciiWord &&
        this._parserContext.log.addMessageForTokenSequence(
          w.ReferenceMissingLabel,
    ...
    (r.prototype._parseHtmlStartTag = function (e) {
      e.assertAccumulatedSequenceIsEmpty()
      var t = e.createMarker(),
        n = e.readToken()
      if (n.kind !== p.LessThan)
      ...
      for (
        ...
        var u = this._parseHtmlAttribute(e)
        if (kt(u))
          return this._backtrackAndCreateErrorForFailure(
            e,
            t,
      ...
      var d = e.createMarker(),
        h = !1
      if (
        (e.peekTokenKind() === p.Slash && (e.readToken(), (h = !0)),
        e.peekTokenKind() !== p.GreaterThan)
      ) {
        var j = this._createFailureForTokensSince(
          e,
          w.HtmlTagMissingGreaterThan,
    ...
    (r.prototype._parseHtmlAttribute = function (e) {
      e.assertAccumulatedSequenceIsEmpty()
      var t = this._parseHtmlName(e)
      if (kt(t)) return t
      var n = this._tryReadSpacingAndNewlines(e)
      if (e.peekTokenKind() !== p.Equals)
        return this._createFailureForToken(
          e,
          w.HtmlTagMissingEquals,
      ...
      return new Vt({
        ...
        configuration: this._configuration,
        nameExcerpt: t,
        spacingAfterNameExcerpt: n,
        equalsExcerpt: i,
        spacingAfterEqualsExcerpt: o,
        valueExcerpt: l,
        spacingAfterValueExcerpt: u,
      })
    }),
    (r.prototype._parseHtmlString = function (e) {
      var t = e.createMarker(),
        n = e.peekTokenKind()
      if (n !== p.DoubleQuote && n !== p.SingleQuote)
        return this._createFailureForToken(
          e,
          w.HtmlTagMissingString,
    ...
    (r.prototype._parseHtmlEndTag = function (e) {
      ...
      if (e.peekTokenKind() !== p.GreaterThan) {
        var u = this._createFailureForToken(
          e,
          w.HtmlTagMissingGreaterThan,
          'Expecting a closing ">" for the HTML tag',
        )
        return this._backtrackAndCreateErrorForFailure(e, t, '', u)
      }
      e.readToken()
    ...
    (r.prototype._parseHtmlName = function (e) {
      var t = e.createMarker()
      if (e.peekTokenKind() === p.Spacing)
      ...
      var o = i.toString(),
        a = J.explainIfInvalidHtmlName(o)
      return a
        ? this._createFailureForTokensSince(e, w.MalformedHtmlName, a, t)
        : this._configuration.validation.reportUnsupportedHtmlElements &&
            !this._configuration.isHtmlElementSupported(o)
          ? this._createFailureForToken(
              e,
              w.UnsupportedHtmlElementName,
    ...
    (r.prototype._parseFencedCode = function (e) {
      e.assertAccumulatedSequenceIsEmpty()
      var t = e.createMarker(),
        n = t + 2
      switch (e.peekPreviousTokenKind()) {
      ...
      for (
        var o = e.extractAccumulatedSequence();
        e.peekTokenKind() === p.Spacing;
      )
        e.readToken()
      for (var a = e.tryExtractAccumulatedSequence(), l = !1, u = void 0; !l; )
        switch (e.peekTokenKind()) {
          case p.Spacing:
          case p.Newline:
            ;(u === void 0 && (u = e.createMarker()),
              e.peekTokenKind() === p.Newline && (l = !0),
              e.readToken())
            break
          case p.Backtick:
            var d = this._createFailureForToken(
              e,
              w.CodeFenceSpecifierSyntax,
          ...
          case p.EndOfInput:
            var h = this._createFailureForToken(
              e,
              w.CodeFenceMissingDelimiter,
          ...
          default:
            ;((u = void 0), e.readToken())
            break
        }
      var j = e.extractAccumulatedSequence(),
        E = j.getNewSequence(j.startIndex, u),
        M = j.getNewSequence(u, j.endIndex),
        I = -1,
        K = -1
      l = !1
      for (var D; !l; )
        switch (e.peekTokenKind()) {
          ...
          case p.Newline:
            for (
              D = e.readToken(), I = e.createMarker();
              e.peekTokenKind() === p.Spacing;
            )
              D = e.readToken()
            if (
              e.peekTokenKind() !== p.Backtick ||
              ((K = e.createMarker()),
              e.readToken(),
              e.peekTokenKind() !== p.Backtick) ||
              (e.readToken(), e.peekTokenKind() !== p.Backtick)
            )
              break
            ;(e.readToken(), (l = !0))
            break
      ...
      D.kind !== p.Newline &&
        this._parserContext.log.addMessageForTextRange(
          w.CodeFenceClosingIndent,
          'The closing delimiter for a code fence must not be indented',
          D.range,
        )
      var R = e.extractAccumulatedSequence(),
        oe = R.getNewSequence(R.startIndex, I),
        ae = R.getNewSequence(I, K),
        W = R.getNewSequence(K, R.endIndex)
      for (l = !1; !l; )
        switch (e.peekTokenKind()) {
          case p.Spacing:
            e.readToken()
      ...
      var Ue = e.tryExtractAccumulatedSequence()
      return new Gt({
        parsed: !0,
        configuration: this._configuration,
        ...
        languageExcerpt: E,
        spacingAfterLanguageExcerpt: M,
        codeExcerpt: oe,
        spacingBeforeClosingFenceExcerpt: ae,
        closingFenceExcerpt: W,
        spacingAfterClosingFenceExcerpt: Ue,
      })
    }),
    (r.prototype._parseCodeSpan = function (e) {
      e.assertAccumulatedSequenceIsEmpty()
      var t = e.createMarker()
      if (e.peekTokenKind() !== p.Backtick)
        throw new Error(
          'Expecting a code span starting with a backtick character "`"',
        )
      e.readToken()
      for (var n = e.extractAccumulatedSequence(), i = void 0, o = void 0; ; ) {
        ...
        if (a === p.EndOfInput || a === p.Newline)
          return this._backtrackAndCreateError(
            e,
            t,
            w.CodeSpanMissingDelimiter,
    ...
    (r.prototype._tryReadSpacingAndNewlines = function (e) {
      var t = !1
      do
        switch (e.peekTokenKind()) {
          case p.Spacing:
    ...
    (r.prototype._createError = function (e, t, n) {
      e.readToken()
      var i = e.extractAccumulatedSequence(),
        o = new Ve({
          parsed: !0,
    ...
    (r.prototype._backtrackAndCreateError = function (e, t, n, i) {
      return (e.backtrackToMarker(t), this._createError(e, n, i))
    }),
    (r.prototype._backtrackAndCreateErrorRange = function (e, t, n, i, o) {
      for (e.backtrackToMarker(t); e.createMarker() !== n; ) e.readToken()
      e.peekTokenKind() !== p.EndOfInput && e.readToken()
      var a = e.extractAccumulatedSequence(),
        l = new Ve({
          parsed: !0,
          configuration: this._configuration,
    ...
    (r.prototype._backtrackAndCreateErrorForFailure = function (e, t, n, i) {
      ...
      var o = e.extractAccumulatedSequence(),
        a = new Ve({
          ...
          errorMessage: n + i.failureMessage,
          errorLocation: i.failureLocation,
        })
      return (this._parserContext.log.addMessageForDocErrorText(a), a)
    }),
    (r.prototype._backtrackAndCreateErrorRangeForFailure = function (
      e,
      t,
      n,
      i,
    ...
    (r.prototype._createFailureForToken = function (e, t, n, i) {
      i || (i = e.createMarker())
      var o = new qe({
        parserContext: this._parserContext,
        startIndex: i,
      ...
      return { failureMessageId: t, failureMessage: n, failureLocation: o }
    }),
    (r.prototype._createFailureForTokensSince = function (e, t, n, i) {
      ...
      return { failureMessageId: t, failureMessage: n, failureLocation: a }
    }),
    r
  )
})()
var Jr = (function () {
  function r() {}
  return (
    (r.splitParagraphs = function (e) {
      if (e instanceof Oe) r.splitParagraphsForSection(e)
      else
        for (var t = 0, n = e.getChildNodes(); t < n.length; t++) {
          var i = n[t]
          r.splitParagraphs(i)
        }
    }),
    (r.splitParagraphsForSection = function (e) {
      for (var t = e.nodes, n = [], i = 0, o = t; i < o.length; i++) {
        var a = o[i]
        a.kind === g.Paragraph ? r._splitParagraph(a, n) : n.push(a)
      }
      ;(e.clearNodes(), e.appendNodes(n))
    }),
    (r._splitParagraph = function (e, t) {
      var n = e.nodes,
        i = new ke({ configuration: e.configuration })
      t.push(i)
      var o
      ;(function (E) {
        ;((E[(E.Start = 0)] = 'Start'),
          (E[(E.AwaitingTrailer = 1)] = 'AwaitingTrailer'),
          (E[(E.ReadingTrailer = 2)] = 'ReadingTrailer'))
      })(o || (o = {}))
      for (var a = o.Start, l = 0; l < n.length; ) {
        var u = !0,
          d = l
        do {
          var h = n[d++]
          if (h.kind === g.SoftBreak) break
          u && (this._isWhitespace(h) || (u = !1))
        } while (d < n.length)
        switch (a) {
          case o.Start:
            u || (a = o.AwaitingTrailer)
            break
          case o.AwaitingTrailer:
            u && (a = o.ReadingTrailer)
            break
        ...
        for (var j = l; j < d; ++j) i.appendNode(n[j])
        l = d
      }
    }),
    (r._isWhitespace = function (e) {
      switch (e.kind) {
        case g.PlainText:
          var t = e
          return r._whitespaceRegExp.test(t.text)
        default:
          return !1
      }
    }),
    (r._whitespaceRegExp = /^\s*$/),
    r
  )
})()
var Hn = (function () {
  function r(e) {
    e ? (this.configuration = e) : (this.configuration = new Mn())
  }
  return (
    (r.prototype.parseString = function (e) {
      return this.parseRange(ye.fromString(e))
    }),
    (r.prototype.parseRange = function (e) {
      var t = new Ln(this.configuration, e)
      if (Vr.extract(t)) {
        t.tokens = Et.readTokens(t.lines)
        var n = new zr(t)
        ;(n.parse(), Jr.splitParagraphs(t.docComment))
      }
      return t
    }),
    r
...
var ie = G(require('obsidian'))
function Le(r) {
  return new Promise((e) => activeWindow.setTimeout(e, r))
}
function Wr() {
  return /(<%(?:-|_)?\s*[*~]{0,1})\+((?:.|\s)*?%>)/g
}
function Yn(r, e) {
  e = (0, ie.normalizePath)(e)
  let t = r.vault.getAbstractFileByPath(e)
  if (!t) throw new T(`Folder "${e}" doesn't exist`)
  if (!(t instanceof ie.TFolder)) throw new T(`${e} is a file, not a folder`)
  return t
}
function De(r, e) {
  e = (0, ie.normalizePath)(e)
  let t = r.vault.getAbstractFileByPath(e)
  if (!t) throw new T(`File "${e}" doesn't exist`)
  if (!(t instanceof ie.TFile)) throw new T(`${e} is a folder, not a file`)
  return t
}
function je(r, e) {
  let t = Yn(r, e),
    n = []
  return (
    ie.Vault.recurseChildren(t, (i) => {
      i instanceof ie.TFile && n.push(i)
    }),
    n.sort((i, o) => i.path.localeCompare(o.path)),
    n
  )
}
async function Qr(r, e) {
  return await Promise.all(
    e.map(async (n) => {
      let i = await r.vault.cachedRead(n)
      return Co(n, i)
    }),
  )
}
...
function Rn(r) {
  let t = new Hn().parseString(r)
  return {
    description: Do(t.docComment.summarySection),
    returns: Po(t.docComment.returnsBlock),
    arguments: No(t.docComment.params),
  }
}
function Do(r) {
  try {
    return r.nodes.map((t) =>
      t
        .getChildNodes()
        .filter((n) => n instanceof me)
        .map((n) => n.text).join(`
`),
    ).join(`
`)
  } catch {
    return (console.error('Failed to parse summary section'), '')
  }
}
function Po(r) {
  if (!r) return ''
  try {
    let e = r.content.nodes[0]?.getChildNodes()[0]
    return e instanceof me ? e.text.trim() : ''
  } catch {
    return ''
  }
}
function No(r) {
  try {
    return r.blocks.map((n) => {
      let i = n.parameterName,
        o = n.content
          .getChildNodes()[0]
          .getChildNodes()
          .filter((a) => a instanceof me)
          .map((a) => a.text)
          .join(' ')
      return new Un(i, o)
    })
...
function Vn(r, e, t) {
  let n = r.instanceOf(HTMLOListElement) ? 'li' : 'p',
    i = r.createEl(n),
    o = r.createEl('b', { text: e })
  return (
    i.appendChild(o),
    i.appendChild(activeDocument.createTextNode(`: ${t}`)),
    i
  )
}
function ln(r, e) {
      ...
      if (Object.prototype.hasOwnProperty.call(e, t))
        if (Object.prototype.hasOwnProperty.call(r, t)) {
          ...
          if (Array.isArray(n) || Array.isArray(i)) {
            ...
            r[t] = o.concat(a).unique()
          } else ct(n) && ct(i) ? ln(n, i) : i != null && i !== '' && (r[t] = i)
        } else r[t] = e[t]
  }
}
function St(r) {
  let e = {},
    t = (0, ie.getFrontMatterInfo)(r)
  if (t.frontmatter)
    try {
      e = (0, ie.parseYaml)(t.frontmatter)
    } catch {
      return { frontmatter: e, content: r }
    }
  return { frontmatter: e, content: r.slice(t.contentStart) }
}
var un = G(require('obsidian'))
var he
;(function (t) {
  ;((t[(t.TemplateFiles = 0)] = 'TemplateFiles'),
    (t[(t.ScriptFiles = 1)] = 'ScriptFiles'))
})(he || (he = {}))
var lt = class extends un.AbstractInputSuggest {
  constructor(e, t, n) {
    super(t.app, e)
    this.inputEl = e
    this.plugin = t
  ...
  getSuggestions(e) {
    ...
    return (
      t.forEach((o) => {
        o instanceof un.TFile &&
          o.extension === 'md' &&
          o.path.toLowerCase().includes(i) &&
          n.push(o)
      }),
      n.slice(0, 1e3)
    )
  ...
  selectSuggestion(e) {
    ;(this.setValue(e.path), this.inputEl.trigger('input'), this.close())
  }
}
var pn = G(require('obsidian')),
  ut = class extends pn.AbstractInputSuggest {
    constructor(e, t) {
      super(e, t)
      this.inputEl = t
    }
...
function Xr(r) {
  return isBoolean(r) ? r : [1, 3].includes(r)
}
function Zr(r) {
  return isBoolean(r) ? r : [1, 2].includes(r)
}
function ei(r) {
  return isBoolean(r) ? r : r != 0
}
var ti = {
    command_timeout: 5,
    templates_folder: '',
    ...
    startup_templates: [''],
    intellisense_render: Ne.RenderDescriptionParameterReturn,
    ignore_folders_on_creation: [{ folder: '' }],
  },
  zn = class extends P.PluginSettingTab {
    constructor(e) {
      super(e.app, e)
      this.plugin = e
    ...
    add_template_folder_setting() {
      new P.Setting(this.containerEl)
        .setName('Template folder location')
        .setDesc('Files in this folder will be available as templates.')
        .addSearch((e) => {
          ;(new ut(this.app, e.inputEl),
            e
    ...
    add_syntax_highlighting_settings() {
      ...
      ;(t.append(
        ...
        new P.Setting(this.containerEl)
          ...
          .setDesc(e)
          .addToggle((n) => {
            n.setValue(this.plugin.settings.syntax_highlighting).onChange(
              async (i) => {
        ...
        new P.Setting(this.containerEl)
          ...
          .addToggle((t) => {
            t.setValue(this.plugin.settings.auto_jump_to_cursor).onChange(
              async (n) => {
                ;((this.plugin.settings.auto_jump_to_cursor = n),
                  await this.plugin.save_settings())
              },
            )
          }))
        ...
        new P.Setting(this.containerEl)
          ...
          .addToggle((t) => {
            t.setValue(this.plugin.settings.trigger_on_file_creation).onChange(
              async (n) => {
                ;((this.plugin.settings.trigger_on_file_creation = n),
                  await this.plugin.save_settings(),
    ...
    add_templates_hotkeys_setting() {
      new P.Setting(this.containerEl).setName('Template hotkeys').setHeading()
      let e = createFragment()
      ;(e.append('Template hotkeys allows you to bind a template to a hotkey.'),
        new P.Setting(this.containerEl).setDesc(e),
        this.plugin.settings.enabled_templates_hotkeys.forEach((t, n) => {
          new P.Setting(this.containerEl)
            .addSearch((o) => {
              ;(new lt(o.inputEl, this.plugin, he.TemplateFiles),
                o
                  ...
                  .onChange(async (a) => {
                    if (
                      ...
                      z(new T('This template is already bound to a hotkey'))
                      return
                    }
                    ;(this.plugin.command_handler.add_template_hotkey(
                      this.plugin.settings.enabled_templates_hotkeys[n],
                      a,
                    ),
                      (this.plugin.settings.enabled_templates_hotkeys[n] = a),
                      await this.plugin.save_settings())
                  }),
              ...
              o.setIcon('cross')
                ...
                .onClick(async () => {
                  ;(this.plugin.command_handler.remove_template_hotkey(
                    ...
                    this.plugin.settings.enabled_templates_hotkeys.splice(n, 1),
                    await this.plugin.save_settings(),
                    this.display())
                })
            })
        ...
        new P.Setting(this.containerEl).addButton((t) => {
    ...
    add_folder_templates_setting() {
      new P.Setting(this.containerEl).setName('Folder templates').setHeading()
      let e = createFragment()
      ;(e.append(
      ...
      ;(t.append(
        ...
        new P.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((n) => {
            n.setValue(this.plugin.settings.enable_folder_templates).onChange(
              async (i) => {
        ...
        !!this.plugin.settings.enable_folder_templates &&
          (this.plugin.settings.folder_templates.forEach((n, i) => {
            new P.Setting(this.containerEl)
              .addSearch((a) => {
                ;(new ut(this.app, a.inputEl),
                  a
              ...
              .addSearch((a) => {
                ;(new lt(a.inputEl, this.plugin, he.TemplateFiles),
                  a
              ...
              .addExtraButton((a) => {
                a.setIcon('up-chevron-glyph')
                  .setTooltip('Move up')
                  .onClick(async () => {
                    ;(Pe(this.plugin.settings.folder_templates, i, i - 1),
                      await this.plugin.save_settings(),
                      this.display())
                  })
              })
          ...
          new P.Setting(this.containerEl).addButton((n) => {
            n.setButtonText('Add new folder template')
    ...
    add_file_templates_setting() {
      ...
      ;(t.append(
        ...
        new P.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((n) => {
            n.setValue(this.plugin.settings.enable_file_templates).onChange(
              async (i) => {
        ...
        !!this.plugin.settings.enable_file_templates &&
          (this.plugin.settings.file_templates.forEach((n, i) => {
            new P.Setting(this.containerEl)
              .addText((a) => {
                ;(a
              ...
              .addExtraButton((a) => {
                a.setIcon('up-chevron-glyph')
                  .setTooltip('Move up')
                  .onClick(async () => {
                    ;(Pe(this.plugin.settings.file_templates, i, i - 1),
                      await this.plugin.save_settings(),
                      this.display())
                  })
              })
          ...
          new P.Setting(this.containerEl).addButton((n) => {
            n.setButtonText('Add new file regex')
    ...
    add_startup_templates_setting() {
      new P.Setting(this.containerEl).setName('Startup templates').setHeading()
      let e = createFragment()
      ;(e.append(
        ...
        new P.Setting(this.containerEl).setDesc(e),
        this.plugin.settings.startup_templates.forEach((t, n) => {
          new P.Setting(this.containerEl)
            .addSearch((o) => {
              ;(new lt(o.inputEl, this.plugin, he.TemplateFiles),
                o
                  ...
                  .onChange(async (a) => {
                    if (
                      ...
                      z(new T('This startup template already exist'))
                      return
                    }
                    ;((this.plugin.settings.startup_templates[n] = a),
                      await this.plugin.save_settings())
                  }),
                o.containerEl.addClass('templater_search'))
            })
            .addExtraButton((o) => {
              o.setIcon('cross')
                .setTooltip('Delete')
                .onClick(async () => {
                  ;(this.plugin.settings.startup_templates.splice(n, 1),
                    await this.plugin.save_settings(),
                    this.display())
                })
            })
        ...
        new P.Setting(this.containerEl)
          ...
          .addSearch((n) => {
            ;(new ut(this.app, n.inputEl),
              ...
              n.containerEl.addClass('templater_search'))
          }),
        new P.Setting(this.containerEl)
          ...
          .addDropdown((n) => {
            n.addOption('0', 'Turn off intellisense')
              .addOption(
                '1',
    ...
    add_user_system_command_functions_setting() {
      ...
      if (
        ...
        new P.Setting(this.containerEl)
          ...
          .addToggle((t) => {
            t.setValue(this.plugin.settings.enable_system_commands).onChange(
              async (n) => {
                ;((this.plugin.settings.enable_system_commands = n),
                  await this.plugin.save_settings(),
                  this.display())
              },
            )
          ...
          .addText((o) => {
            o.setPlaceholder('Timeout')
              ...
              .onChange(async (a) => {
                let l = Number(a)
                if (isNaN(l)) {
                  z(new T('Timeout must be a number'))
                  return
                }
        ...
        this.plugin.settings.templates_pairs.forEach((o) => {
          let a = this.containerEl.createDiv()
          a.addClass('templater_div')
          let l = new P.Setting(this.containerEl)
            .setName('User function n\xB0' + t)
            .setHeading()
          ;(l.nameEl.addClass('templater_title'),
            new P.Setting(this.containerEl)
              .addExtraButton((d) => {
                d.setIcon('cross')
                  .setTooltip('Delete')
                  .onClick(async () => {
                    let h = this.plugin.settings.templates_pairs.indexOf(o)
                    h > -1 &&
                      (this.plugin.settings.templates_pairs.splice(h, 1),
                      await this.plugin.save_settings(),
                      this.display())
                  })
              })
              .addText((d) => {
                let h = d
                  ...
                  .setValue(o[0])
                  .onChange(async (j) => {
                    let E = this.plugin.settings.templates_pairs.indexOf(o)
                    E > -1 &&
                      ((this.plugin.settings.templates_pairs[E][0] = j),
                      await this.plugin.save_settings())
                  })
                return (h.inputEl.addClass('templater_template'), h)
              })
              .addTextArea((d) => {
                let h = d
                  ...
                  .onChange(async (j) => {
                    let E = this.plugin.settings.templates_pairs.indexOf(o)
                    E > -1 &&
                      ((this.plugin.settings.templates_pairs[E][1] = j),
                      await this.plugin.save_settings())
                  })
                return (
                  h.inputEl.setAttr('rows', 2),
                  h.inputEl.addClass('templater_cmd'),
                  h
                )
              })
              .infoEl.remove(),
            a.appendChild(l.settingEl),
            a.appendChild(this.containerEl.lastChild),
            (t += 1))
        })
        let n = this.containerEl.createDiv()
        ;(n.addClass('templater_div2'),
          new P.Setting(this.containerEl)
            ...
            .infoEl.remove(),
          n.appendChild(this.containerEl.lastChild))
      }
    }
    add_ignore_folders_on_creation_setting() {
      new P.Setting(this.containerEl)
      ...
      ;(e.append(
        ...
        new P.Setting(this.containerEl).setDesc(e),
        this.plugin.settings.ignore_folders_on_creation.forEach((t, n) => {
          new P.Setting(this.containerEl)
            .addSearch((o) => {
              ;(new ut(this.app, o.inputEl),
                o
                  .setPlaceholder('Folder')
                  .setValue(t.folder)
                  .onChange(async (a) => {
                    if (
                      ...
                      z(new T('This folder is already in the ignore list'))
                      return
                    }
        ...
        new P.Setting(this.containerEl).addButton((t) => {
          t.setButtonText('Add folder to ignore list')
...
var Jn = class extends fn.FuzzySuggestModal {
  ...
  getItemText(e) {
    ...
    if (
      ...
      (0, fn.normalizePath)(this.plugin.settings.templates_folder) != '/'
    ) {
      let n = this.plugin.settings.templates_folder.length,
        i
      ;(n === 0
        ? (i = 0)
        : this.plugin.settings.templates_folder.endsWith('/')
          ? (i = n)
          : (i = n + 1),
        (t = e.path.slice(i)))
    }
  ...
  start() {
    try {
      ...
      z(e instanceof Error ? e : new Error(String(e)))
    }
  }
  insert_template() {
...
var ni = 'Error_MobileUnsupportedTemplate',
  ri =
...
var Y = G(require('obsidian'))
var Me = G(require('obsidian'))
var re = class {
  constructor(e) {
    this.plugin = e
...
var Wn = class extends re {
  ...
  async teardown() {}
  generate_now() {
    return (e = 'YYYY-MM-DD', t, n, i) => {
      if (n && !(0, Me.moment)(n, i).isValid())
        throw new T(
      ...
      return (
        typeof t == 'string'
          ? (o = Me.moment.duration(t))
          : typeof t == 'number' && (o = Me.moment.duration(t, 'days')),
        (0, Me.moment)(n, i).add(o).format(e)
      )
    }
  }
  generate_tomorrow() {
    return (e = 'YYYY-MM-DD') => (0, Me.moment)().add(1, 'days').format(e)
  }
  generate_weekday() {
    return (e = 'YYYY-MM-DD', t, n, i) => {
      if (n && !(0, Me.moment)(n, i).isValid())
      ...
      return (0, Me.moment)(n, i).weekday(t).format(e)
    }
  }
  generate_yesterday() {
    return (e = 'YYYY-MM-DD') => (0, Me.moment)().add(-1, 'days').format(e)
...
var ii = 10,
  Qn = class extends re {
    ...
    generate_create_new() {
      return async (e, t, n = !1, i) => {
        if (((this.create_new_depth += 1), this.create_new_depth > ii))
          throw (
            (this.create_new_depth = 0),
            new T('Reached create_new depth limit (max = 10)')
          )
    ...
    generate_creation_date() {
      return (e = 'YYYY-MM-DD HH:mm') =>
        (0, V.moment)(this.config.target_file.stat.ctime).format(e)
    }
    generate_cursor() {
    ...
    generate_cursor_append() {
      return (e) => {
        ...
        if (!t || !t.editor) {
          z(new T("No active editor, can't append to cursor."))
          return
        }
    ...
    generate_folder() {
      return (e = !1) => {
        ...
        if (!(t instanceof V.TFolder)) return ''
        let n
        return (e ? (n = t.path) : (n = t.name), n)
      }
    }
    generate_include() {
      return async (e) => {
        if (((this.include_depth += 1), this.include_depth > ii))
          throw (
            (this.include_depth -= 1),
            new T('Reached inclusion depth limit (max = 10)')
          )
        let t
        if (e instanceof V.TFile) t = await this.plugin.app.vault.read(e)
        else {
          let n
          if ((n = this.linkpath_regex.exec(e)) === null)
            throw (
              (this.include_depth -= 1),
              new T(
          ...
          let { path: i, subpath: o } = (0, V.parseLinktext)(n[1]),
            a = this.plugin.app.metadataCache.getFirstLinkpathDest(i, '')
          if (!a)
            throw ((this.include_depth -= 1), new T(`File ${e} doesn't exist`))
          if (((t = await this.plugin.app.vault.read(a)), o)) {
            let l = this.plugin.app.metadataCache.getFileCache(a)
            if (l) {
              let u = (0, V.resolveSubpath)(l, o)
              u && (t = t.slice(u.start.offset, u.end?.offset))
            }
          }
        }
        try {
          ...
          return ((this.include_depth -= 1), n)
        } catch (n) {
          throw ((this.include_depth -= 1), n)
        }
      }
    }
    generate_last_modified_date() {
      return (e = 'YYYY-MM-DD HH:mm') =>
        (0, V.moment)(this.config.target_file.stat.mtime).format(e)
    }
    generate_move() {
      return async (e, t) => {
        let n = t || this.config.target_file,
          i = (0, V.normalizePath)(`${e}.${n.extension}`),
          o = i.replace(/\\/g, '/').split('/')
        if ((o.pop(), o.length)) {
          let a = o.join('/')
        ...
        return (await this.plugin.app.fileManager.renameFile(n, i), '')
      }
    }
    generate_path() {
      return (e = !1) => {
        ...
        if (V.Platform.isMobile) {
          ...
          t = `${n}/${i}`
        } else if (this.plugin.app.vault.adapter instanceof V.FileSystemAdapter)
          t = this.plugin.app.vault.adapter.getBasePath()
        else throw new T('app.vault is not a FileSystemAdapter instance')
        return e
    ...
    generate_rename() {
      return async (e) => {
        ...
        let t = this.config.target_file.parent
        if (!(t instanceof V.TFolder)) return ''
        let n = (0, V.normalizePath)(
          `${t.path}/${e}.${this.config.target_file.extension}`,
        )
        return (
    ...
    generate_selection() {
      return () => {
        ...
        if (!e || !e.editor)
          throw new T("Active editor is null, can't read selection.")
    ...
    generate_tags() {
      ...
      return e ? (0, V.getAllTags)(e) : null
    }
    generate_title() {
      return this.config.target_file.basename
    }
  }
var oi = G(require('obsidian'))
var Xn = class extends re {
  constructor() {
    super(...arguments)
    this.name = 'web'
  }
  ...
  async getRequest(e) {
    try {
      let t = await (0, oi.requestUrl)(e)
      if (t.status < 200 && t.status >= 300)
        throw new T('Error performing GET request')
      return t
    } catch {
      throw new T('Error performing GET request')
    }
...
> \u2014 ${o}`
        ...
        return (
          new T('Error generating daily quote'),
  ...
  generate_random_picture() {
    return async (e, t, n = !1) => {
      try {
        ...
        return (
          new T('Error generating random picture'),
  ...
  generate_request() {
    return async (e, t) => {
      try {
        let i = (await this.getRequest(e)).json
        return t && i
          ? t.split('.').reduce((o, a) => {
              if (Object.prototype.hasOwnProperty.call(o, a)) return o[a]
              throw new Error(`Path ${t} not found in the JSON response`)
            }, i)
          : i
      } catch (n) {
        throw (console.error(n), new T('Error fetching and extracting value'))
      }
    }
  }
}
...
var we = G(require('obsidian'))
var tr = class extends we.Modal {
  constructor(e, t, n, i) {
    super(e)
    this.prompt_text = t
  ...
  onClose() {
    ;(this.contentEl.empty(),
      this.submitted || this.reject(new T('Cancelled prompt')))
  }
  createForm() {
    ...
    let t
    this.multi_line
      ? (t = new we.TextAreaComponent(e))
      : (t = new we.TextComponent(e))
    let n = this.contentEl.createDiv()
    n.addClass('templater-button-div')
    let i = new we.ButtonComponent(n)
...
var ai = G(require('obsidian')),
  nr = class extends ai.FuzzySuggestModal {
    constructor(e, t, n, i, o, a) {
      super(e)
      this.text_items = t
      this.items = n
      this.default_value = a
      this.submitted = !1
...
var le = G(require('obsidian')),
  rr = class extends le.Modal {
    constructor(e, t, n, i, o, a) {
      super(e)
      this.text_items = t
      this.items = n
      ...
      let l = this.contentEl.createDiv('templater-multisuggester-div'),
        u = new le.TextComponent(l)
      ;(u.inputEl.addClass('templater-multisuggester-input'),
        (this.suggester = new si(
          e,
          u.inputEl,
          (h) => this.getItemText(h),
          n,
          o,
        ).onSelect((h) => this.onChooseItem(h))))
      let d = this.contentEl.createDiv('modal-button-container')
      ;(new le.ButtonComponent(d)
        .setButtonText('Save')
        .setCta()
        .onClick(() => this.save()),
        new le.ButtonComponent(d)
    ...
    onChooseItem(e) {
      ;(this.selectedItems.push(e), this.processSelectedItems())
    }
    processSelectedItems() {
      let e = this.items.filter((t) => !this.selectedItems.some((n) => n === t))
      ;(this.suggester.setItems(e), this.display())
    }
    onRemoveItem(e) {
      this.selectedItems = this.selectedItems.filter((n) => n !== e)
      let t = this.items.filter((n) => !this.selectedItems.some((i) => i === n))
  ...
  si = class extends le.AbstractInputSuggest {
    ...
    getSuggestions(e) {
      let t = (0, le.prepareFuzzySearch)(e)
      return this.items.reduce((n, i) => {
        let o = this.getItemText(i)
        return (t(o) && n.push(i), n)
      }, [])
    }
    renderSuggestion(e, t) {
...
var ir = class extends re {
  ...
  generate_prompt() {
    return async (e, t, n = !1, i = !1) => {
      let o = new tr(this.plugin.app, e, t, i),
        a = new Promise((l, u) => {
          o.openAndGetValue(l, u)
        })
      try {
        return await a
      } catch (l) {
  ...
  generate_suggester() {
    return async (e, t, n = !1, i = '', o, a) => {
      let l = new nr(this.plugin.app, e, t, i, o, a),
        u = new Promise((d, h) => {
          l.openAndGetValue(d, h)
        })
      try {
        return await u
      } catch (d) {
  ...
  generate_multi_suggester() {
    return async (e, t, n = !1, i = '', o, a) => {
      let l = new rr(this.plugin.app, e, t, i, o, a),
        u = new Promise((d, h) => {
          l.openAndGetValue(d, h)
        })
      try {
...
var ar = class {
  constructor(e) {
    this.plugin = e
    this.modules_array = []
    ;(this.modules_array.push(new Wn(this.plugin)),
      this.modules_array.push(new Qn(this.plugin)),
      this.modules_array.push(new Xn(this.plugin)),
      this.modules_array.push(new er(this.plugin)),
      this.modules_array.push(new Zn(this.plugin)),
      this.modules_array.push(new ir(this.plugin)),
      this.modules_array.push(new or(this.plugin)))
  }
  async init() {
...
var Ct = G(require('obsidian'))
var sr = class {
  constructor(e) {
    this.plugin = e
    if (
      Ct.Platform.isMobile ||
      !(this.plugin.app.vault.adapter instanceof Ct.FileSystemAdapter)
    )
      this.cwd = ''
    else {
        ...
        (Ct.Platform.isMobile
          ...
          : ((a = await this.plugin.templater.parser.parse_commands(a, n)),
            t.set(o, async (l) => {
              ...
              try {
                let { stdout: h } = await this.exec_promise(a, d)
                return h.trimRight()
              } catch (h) {
                throw new T(
                  `Error with User Template ${o}`,
...
var Dt = class {
  ...
  async load_user_script_function(e, t) {
    let n = (u) => window.require && window.require(u),
      i = {},
      o = { exports: i },
    ...
    try {
      ...
      throw new T(
        `Failed to load user script at "${e.path}".`,
    ...
    if (typeof l == 'function') t.set(e.basename, l)
      ...
      if (!Object.values(l).every((d) => typeof d == 'function'))
        throw new T(
          `Exported object in "${e.path}" must contain only functions.`,
        )
      t.set(e.basename, l)
    } else
      throw new T(
        `Invalid export in "${e.path}". Must be a function or object of functions.`,
      )
  }
...
var cr = class {
  constructor(e) {
    this.plugin = e
    ;((this.user_system_functions = new sr(e)),
      (this.user_script_functions = new Dt(e)))
  }
  async generate_object(e) {
    let t = {},
      n = {}
    return (
      ...
      this.plugin.settings.user_scripts_folder &&
        (n = await this.user_script_functions.generate_object()),
      { ...t, ...n }
    )
  }
}
var Mo = G(require('obsidian')),
  ve
;(function (t) {
...
var lr = class {
  constructor(e) {
    this.plugin = e
    ;((this.internal_functions = new ar(this.plugin)),
      (this.user_functions = new cr(this.plugin)))
  }
  async init() {
  ...
  additional_functions() {
    return { app: this.plugin.app, obsidian: Mo }
  }
  async generate_object(e, t = 1) {
    let n = {},
      ...
      a = {}
    switch ((Object.assign(n, i), t)) {
      case 0:
        Object.assign(n, o)
        break
      case 1:
        ;((a = await this.user_functions.generate_object(e)),
          Object.assign(n, { ...o, user: a }))
        break
    }
    return n
  }
...
var ci = new TextDecoder('utf-8', { ignoreBOM: !0, fatal: !0 })
ci.decode()
var dn = new Uint8Array()
function gn() {
  return (dn.byteLength === 0 && (dn = new Uint8Array(b.memory.buffer)), dn)
}
function He(r, e) {
  return ci.decode(gn().subarray(r, r + e))
}
function Ke(r) {
  Pt === Ae.length && Ae.push(Ae.length + 1)
  let e = Pt
  return ((Pt = Ae[e]), (Ae[e] = r), e)
}
var _e = 0,
  mn = new TextEncoder('utf-8'),
  Io =
    typeof mn.encodeInto == 'function'
      ? function (r, e) {
          return mn.encodeInto(r, e)
        }
      : function (r, e) {
          let t = mn.encode(r)
...
function Fe(r, e, t) {
  ...
  if (a !== n) {
    ;(a !== 0 && (r = r.slice(a)), (i = t(i, n, (n = a + r.length * 3))))
    let l = gn().subarray(i + a, i + n)
    a += Io(r, l).written
  }
  return ((_e = a), i)
}
...
var hn = new Int32Array()
function pe() {
  return (hn.byteLength === 0 && (hn = new Int32Array(b.memory.buffer)), hn)
}
function pr(r) {
  let e = typeof r
  ...
  if (Array.isArray(r)) {
    let i = r.length,
      o = '['
    i > 0 && (o += pr(r[0]))
    for (let a = 1; a < i; a++) o += ', ' + pr(r[a])
    return ((o += ']'), o)
  }
  let t = /\[object ([^\]]+)\]/.exec(toString.call(r)),
    n
  if (t.length > 1) n = t[1]
...
var An = 32
function qo(r) {
  if (An == 1) throw new Error('out of js stack')
  return ((Ae[--An] = r), An)
}
function fr(r, e) {
  try {
    ...
    b.__wbindgen_exn_store(Ke(t))
  }
}
var Je = class {
    static __wrap(e) {
      let t = Object.create(Je.prototype)
      return ((t.ptr = e), t)
    }
    __destroy_into_raw() {
      let e = this.ptr
    ...
    free() {
      ...
      b.__wbg_parserconfig_free(e)
    }
    get interpolate() {
      let e = b.__wbg_get_parserconfig_interpolate(this.ptr)
      return String.fromCodePoint(e)
    }
    set interpolate(e) {
      b.__wbg_set_parserconfig_interpolate(this.ptr, e.codePointAt(0))
    }
    get execution() {
      let e = b.__wbg_get_parserconfig_execution(this.ptr)
      return String.fromCodePoint(e)
    }
    set execution(e) {
      b.__wbg_set_parserconfig_execution(this.ptr, e.codePointAt(0))
    }
    get single_whitespace() {
      let e = b.__wbg_get_parserconfig_single_whitespace(this.ptr)
      return String.fromCodePoint(e)
    }
    set single_whitespace(e) {
      b.__wbg_set_parserconfig_single_whitespace(this.ptr, e.codePointAt(0))
    }
    get multiple_whitespace() {
      let e = b.__wbg_get_parserconfig_multiple_whitespace(this.ptr)
      return String.fromCodePoint(e)
    }
    set multiple_whitespace(e) {
      b.__wbg_set_parserconfig_multiple_whitespace(this.ptr, e.codePointAt(0))
    }
    constructor(e, t, n, i, o, a, l) {
      let u = Fe(e, b.__wbindgen_malloc, b.__wbindgen_realloc),
        d = _e,
        h = Fe(t, b.__wbindgen_malloc, b.__wbindgen_realloc),
        j = _e,
        E = Fe(l, b.__wbindgen_malloc, b.__wbindgen_realloc),
        M = _e,
        I = b.parserconfig_new(
          u,
          d,
          h,
          j,
    ...
    get opening_tag() {
      try {
        let n = b.__wbindgen_add_to_stack_pointer(-16)
        b.parserconfig_opening_tag(n, this.ptr)
        var e = pe()[n / 4 + 0],
          t = pe()[n / 4 + 1]
        return He(e, t)
      } finally {
        ;(b.__wbindgen_add_to_stack_pointer(16), b.__wbindgen_free(e, t))
      }
    }
    set opening_tag(e) {
      let t = Fe(e, b.__wbindgen_malloc, b.__wbindgen_realloc),
        n = _e
      b.parserconfig_set_opening_tag(this.ptr, t, n)
    }
    get closing_tag() {
      try {
        let n = b.__wbindgen_add_to_stack_pointer(-16)
        b.parserconfig_closing_tag(n, this.ptr)
        var e = pe()[n / 4 + 0],
          t = pe()[n / 4 + 1]
        return He(e, t)
      } finally {
    ...
    set closing_tag(e) {
      let t = Fe(e, b.__wbindgen_malloc, b.__wbindgen_realloc),
        n = _e
      b.parserconfig_set_closing_tag(this.ptr, t, n)
    }
    get global_var() {
      try {
        let n = b.__wbindgen_add_to_stack_pointer(-16)
        b.parserconfig_global_var(n, this.ptr)
        var e = pe()[n / 4 + 0],
          t = pe()[n / 4 + 1]
        return He(e, t)
      } finally {
    ...
    set global_var(e) {
      let t = Fe(e, b.__wbindgen_malloc, b.__wbindgen_realloc),
        n = _e
      b.parserconfig_set_global_var(this.ptr, t, n)
    }
  },
  ft = class {
    static __wrap(e) {
      let t = Object.create(ft.prototype)
      return ((t.ptr = e), t)
    }
    __destroy_into_raw() {
      let e = this.ptr
    ...
    free() {
      let e = this.__destroy_into_raw()
      b.__wbg_renderer_free(e)
    }
    constructor(e) {
      Oo(e, Je)
      var t = e.ptr
      e.ptr = 0
      let n = b.renderer_new(t)
      return ft.__wrap(n)
    }
    render_content(e, t) {
      try {
        let a = b.__wbindgen_add_to_stack_pointer(-16),
          l = Fe(e, b.__wbindgen_malloc, b.__wbindgen_realloc),
          u = _e
        b.renderer_render_content(a, this.ptr, l, u, qo(t))
        var n = pe()[a / 4 + 0],
          i = pe()[a / 4 + 1],
          o = pe()[a / 4 + 2]
        if (o) throw ur(i)
        ...
        ;(b.__wbindgen_add_to_stack_pointer(16), (Ae[An++] = void 0))
      }
    }
  }
...
function $o() {
  ...
  return (
    ...
    (r.wbg.__wbindgen_string_get = function (e, t) {
      ...
      var o = Bo(i) ? 0 : Fe(i, b.__wbindgen_malloc, b.__wbindgen_realloc),
        a = _e
      ;((pe()[e / 4 + 1] = a), (pe()[e / 4 + 0] = o))
    }),
    (r.wbg.__wbg_call_97ae9d8645dc388b = function () {
      return fr(function (e, t) {
        let n = ue(e).call(ue(t))
        return Ke(n)
      }, arguments)
    }),
    (r.wbg.__wbg_new_8d2af00bc1e329ee = function (e, t) {
      let n = new Error(He(e, t))
      return Ke(n)
    }),
    ...
    (r.wbg.__wbg_newwithargs_8fe23e3842840c8e = function (e, t, n, i) {
      let o = new Function(He(e, t), He(n, i))
      return Ke(o)
    }),
    (r.wbg.__wbg_call_168da88779e35f61 = function () {
      return fr(function (e, t, n) {
        let i = ue(e).call(ue(t), ue(n))
        return Ke(i)
      }, arguments)
    }),
    (r.wbg.__wbg_call_3999bee59e9f7719 = function () {
      return fr(function (e, t, n, i) {
        let o = ue(e).call(ue(t), ue(n), ue(i))
        return Ke(o)
      }, arguments)
    }),
    (r.wbg.__wbindgen_debug_string = function (e, t) {
      let n = pr(ue(t)),
        i = Fe(n, b.__wbindgen_malloc, b.__wbindgen_realloc),
        o = _e
      ;((pe()[e / 4 + 1] = o), (pe()[e / 4 + 0] = i))
    }),
...
async function li(r) {
  typeof r == 'undefined' && (r = new URL('rusty_engine_bg.wasm', Uo.url))
  let e = $o()
  ;((typeof r == 'string' ||
    ...
    (r = fetch(r)),
    Ho(e))
  let { instance: t, module: n } = await Lo(await r, e)
  return Ko(t, n)
}
var ui = li
var pi = $r(
...
var dt = class {
  constructor(e) {
    this.plugin = e
    ;((this.functions_generator = new lr(this.plugin)),
      (this.parser = new dr()))
  }
  async setup() {
  ...
  create_running_config(e, t, n) {
    let i = $e(this.plugin.app)
    return { template_file: e, target_file: t, run_mode: n, active_file: i }
  }
  async read_and_parse_template(e) {
    if (!(e.template_file instanceof Y.TFile))
      throw new T('Template file is not a TFile')
    let t = await this.plugin.app.vault.read(e.template_file)
    return this.parse_template(e, t)
  }
  async parse_template(e, t) {
    let n = await this.functions_generator.generate_object(e, ve.USER_INTERNAL)
    return (
  ...
  async create_new_note_from_template(e, t, n, i = !0) {
    if (!t)
      switch (this.plugin.app.vault.getConfig('newFileLocation')) {
        case 'current': {
          let j = $e(this.plugin.app)
          j && (t = j.parent instanceof Y.TFolder ? j.parent : void 0)
          break
        }
        case 'folder':
    ...
    let o = (e instanceof Y.TFile && e.extension) || 'md',
      a = await ne(async () => {
        let h = t instanceof Y.TFolder ? t.path : t,
          j = this.plugin.app.vault.getAvailablePath(
            (0, Y.normalizePath)(`${h ?? ''}/${n || 'Untitled'}`),
            o,
          ),
          E = cn(j)
        return (
          E &&
            !this.plugin.app.vault.getAbstractFileByPathInsensitive(E) &&
            (await this.plugin.app.vault.createFolder(E)),
          this.plugin.app.vault.create(j, '')
        )
    ...
    if (
      (e instanceof Y.TFile
        ? ((u = this.create_running_config(e, a, 0)),
          (d = await ne(
            async () => this.read_and_parse_template(u),
            'Template parsing error, aborting.',
          )))
        : ((u = this.create_running_config(void 0, a, 0)),
          (d = await ne(
            async () => this.parse_template(u, e),
            'Template parsing error, aborting.',
          ))),
      d == null)
    ) {
    ...
    if (
      ...
      let h = this.plugin.app.workspace.getLeaf(!1)
      if (!h) {
        z(new T('No active leaf'))
        return
      }
      ;(await h.openFile(a, { state: { mode: 'source' } }),
        await this.plugin.editor_handler.jump_to_next_cursor_location(a, !0),
        h.setEphemeralState({ rename: 'all' }))
    }
    return (await this.end_templater_task(l), a)
  }
  async append_template_to_active_file(e) {
    let t = this.plugin.app.workspace.getActiveViewOfType(Y.MarkdownView),
      n = this.plugin.app.workspace.activeEditor
    if (!n || !n.file || !n.editor) {
      z(new T("No active editor, can't append templates."))
      return
    }
    let { path: i } = n.file
    this.start_templater_task(i)
    let o = this.create_running_config(e, n.file, 1),
      a = await ne(
    ...
    let { content: l, frontmatter: u } = St(a),
      h = n.editor.getDoc(),
      j = h.listSelections()
    ;(h.replaceSelection(l),
      t &&
        (Object.keys(u).length > 0 &&
          t instanceof Y.MarkdownView &&
          typeof t.metadataEditor?.insertProperties == 'function' &&
          t.metadataEditor.insertProperties(u),
        await Le(100),
        await t.save()),
      this.plugin.app.workspace.trigger('templater:template-appended', {
        ...
        content: a,
        oldSelections: j,
        newSelections: h.listSelections(),
      }),
      await this.plugin.editor_handler.jump_to_next_cursor_location(n.file, !0),
      await this.end_templater_task(i))
  }
  async write_template_to_file(e, t) {
    let { path: n } = t
    this.start_templater_task(n)
    let i = this.plugin.app.workspace.getActiveViewOfType(Y.MarkdownView),
    ...
    let { content: d, frontmatter: h } = St(u)
    if (a?.path === t.path && o && o.editor && i) {
      let j = '',
        { content: E, frontmatter: M } = St(o.editor.getValue())
      ;(ln(M, h),
...
`),
      ...
      await this.plugin.app.vault.process(t, (j) => {
        let E = '',
          { content: M, frontmatter: I } = St(j)
        return (
          ln(I, h),
...
`),
  ...
  async overwrite_active_file_commands() {
    let e = this.plugin.app.workspace.activeEditor
    if (!e || !e.file) {
      z(new T("Active editor is null, can't overwrite content"))
      return
    }
    await this.overwrite_file_commands(e.file, !0)
  }
  ...
  async process_dynamic_templates(e, t) {
    let n = Wr(),
      i = activeDocument.createNodeIterator(e, NodeFilter.SHOW_TEXT),
      o,
      a = !1,
      l
    for (; (o = i.nextNode()); ) {
      ...
      if (u !== null) {
        let d = n.exec(u)
        if (d !== null) {
          let h = this.plugin.app.metadataCache.getFirstLinkpathDest(
            '',
            t.sourcePath,
          )
          if (!h || !(h instanceof Y.TFile)) return
          if (!a) {
            a = !0
            let j = this.create_running_config(h, h, 4)
        ...
        for (; d != null; ) {
          let h = d[1] + d[2],
            j = await ne(
              async () => await this.parser.parse_commands(h, l),
              `Command Parsing error in dynamic command '${h}'`,
            )
          if (j == null) return
          let E = n.lastIndex - d[0].length,
            M = n.lastIndex
          ;((u = u.substring(0, E) + j + u.substring(M)),
            (n.lastIndex += j.length - d[0].length),
            (d = n.exec(u)))
        }
        o.nodeValue = u
      }
  ...
  get_new_file_template_for_folder(e) {
    let t = e
    for (; t instanceof Y.TFolder; ) {
      let n = t,
        i = this.plugin.settings.folder_templates.find(
          (o) => o.folder == n.path,
        )
  ...
  static async on_file_creation(e, t, n) {
    if (!(n instanceof Y.TFile) || n.extension !== 'md') return
    let i = (0, Y.normalizePath)(e.plugin.settings.templates_folder)
    if (n.path.includes(i) && i !== '/') return
    for (let u of e.plugin.settings.ignore_folders_on_creation) {
      let d = (0, Y.normalizePath)(u.folder)
      if (n.path.startsWith(d) && d !== '') return
    }
    if ((await Le(300), e.files_with_pending_templates.has(n.path))) return
    let o = await t.vault.read(n),
      a = (0, Y.getFrontMatterInfo)(o),
      l = o.length - a.contentStart
    if (l == 0 && e.plugin.settings.enable_folder_templates) {
      if (!(n.parent instanceof Y.TFolder)) return
      let u = e.get_new_file_template_for_folder(n.parent)
      if (!u) return
      let d = await ne(async () => De(t, u), `Couldn't find template ${u}`)
      if (d == null) return
      await e.write_template_to_file(d, n)
    } else if (l == 0 && e.plugin.settings.enable_file_templates) {
      let u = e.get_new_file_template_for_file(n)
      if (!u) return
      let d = await ne(async () => De(t, u), `Couldn't find template ${u}`)
      if (d == null) return
      await e.write_template_to_file(d, n)
      ...
      n.stat.size <= u
        ...
        : console.debug(
            `Templater skipped parsing ${n.path} because file size exceeds ${u}`,
          )
    }
  }
...
var _n = class {
  ...
  async setup() {
    ;(this.plugin.app.workspace.onLayoutReady(async () => {
      if (
        ...
        let t =
          this.plugin.app.internalPlugins.getEnabledPluginById('daily-notes')
        if (t) {
          let { folder: n, format: i } = t.options,
            o = (0, gt.normalizePath)(`${n}/${(0, gt.moment)().format(i)}.md`),
            a = $e(this.plugin.app)
          a?.path === o &&
            (await dt.on_file_creation(this.templater, this.plugin.app, a))
        }
      }
  ...
  async update_syntax_highlighting() {
  ...
  update_trigger_file_on_creation() {
    this.settings.trigger_on_file_creation
      ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on(
          'create',
          (e) => dt.on_file_creation(this.templater, this.plugin.app, e),
        )),
  ...
  update_file_menu() {
    this.plugin.registerEvent(
      this.plugin.app.workspace.on('file-menu', (e, t) => {
        t instanceof gt.TFolder &&
          e.addItem((n) => {
            n.setTitle('Create new note from template')
...
var gr = class {
  ...
  add_template_hotkey(e, t) {
    if ((this.remove_template_hotkey(e), t)) {
      let n = this.plugin.settings.templates_folder
      ...
      ;(this.plugin.addCommand({
        ...
        callback: async () => {
          let o = ce(
            () => De(this.plugin.app, t),
            "Couldn't find the template file associated with this hotkey",
          )
          !o || (await this.plugin.templater.append_template_to_active_file(o))
        },
      }),
        this.plugin.addCommand({
          id: `create-${t}`,
          ...
          callback: async () => {
            ...
            !o || (await this.plugin.templater.create_new_note_from_template(o))
          },
        }))
    }
  }
  ...
  register_cli_handler() {
    this.plugin.registerCliHandler(
      ...
      'Create a new note from a Templater template',
      {
        ...
        open: { description: 'Open the created file in the UI', required: !1 },
      },
      async (e) => this.handle_create_from_template(e),
    )
  }
  resolve_template_file(e) {
    let t = e
    t.endsWith('.md') || (t = `${t}.md`)
    try {
      return De(this.plugin.app, t)
    } catch {
      let n = this.plugin.settings.templates_folder
      if (n) {
        let i = (0, We.normalizePath)(`${n}/${t}`)
        return De(this.plugin.app, i)
      }
      throw new Error(`Template "${e}" not found`)
    }
  }
  async handle_create_from_template(e) {
    let { template: t, file: n, open: i } = e
    if (!t) return 'Error: template parameter is required'
    if (!n) return 'Error: file parameter is required'
    try {
      let o = this.resolve_template_file(t),
        a = (0, We.normalizePath)(n),
        l = cn(a),
        u = a.slice(l.length + 1).replace(/\.md$/, ''),
        d
      if (l)
        try {
          d = Yn(this.plugin.app, l)
        } catch {}
      let h = i === 'true',
        j = await this.plugin.templater.create_new_note_from_template(
          o,
          d ?? l,
          u,
          h,
        )
      return j ? j.path : 'Error: Failed to create note from template'
    } catch (o) {
      return `Error: ${o instanceof Error ? o.message : String(o)}`
    }
  }
}
var yr = G(require('obsidian'))
var mr = G(require('obsidian'))
var hr = class {
  constructor(e) {
    this.app = e
  }
  async jump_to_next_cursor_location() {
    ...
    let t = e.editor.getValue(),
      { cursor_matches: n, positions: i } =
        this.get_cursor_matches_and_positions(t)
    if (!i || !n) return
    let o = e instanceof mr.MarkdownView ? e.currentMode.getFoldInfo() : null,
      a = []
    for (let l = n.length - 1; l >= 0; l--) {
      let u = n[l],
        d = this.get_editor_position_from_index(t, u.index),
        h = this.get_editor_position_from_index(t, u.index + u[0].length)
      a.push({ from: d, to: h, text: '' })
    }
    ;(e.editor.transaction({
      changes: a,
      selections: i.map((l) => ({ from: l })),
    }),
      o &&
        Array.isArray(o.folds) &&
        (i.forEach((l) => {
          o.folds = o.folds.filter((u) => u.from > l.line || u.to < l.line)
        }),
        e instanceof mr.MarkdownView &&
          (e.currentMode.applyFoldInfo(o), await Le(100), await e.save())))
    try {
...
`,
  ...
  get_cursor_matches_and_positions(e) {
    ...
    n.sort(
      (h, j) => Number(h.groups?.order || 0) - Number(j.groups?.order || 0),
    )
    let o = n[0][0],
      a = n.filter((h) => h[0] === o),
      l = a[0][1] === '' ? [a[0]] : a,
    ...
    for (let h of l) {
      let j = h.index - d
      ;(u.push(this.get_editor_position_from_index(e, j)),
        (e = e.slice(0, j) + e.slice(j + h[0].length)),
        (d += h[0].length))
    }
    return { cursor_matches: l, positions: u }
  }
}
var hi = G(require('obsidian'))
var Ro = {
    app: {
      name: 'app',
      description:
          ...
          args: [
            {
              name: 'format',
              description:
                'The format for the date. Defaults to `"YYYY-MM-DD"`. Refer to the [Momentjs format reference](https://momentjs.com/docs/#/displaying/format/).',
            },
            {
              name: 'offset',
              description:
            ...
            },
            {
              name: 'reference',
              description:
                "The date to use instead of today's date, e.g. set this to the note's title.",
            },
            {
              name: 'reference_format',
              description:
                'The format for the reference date. Refer to the [Momentjs format reference](https://momentjs.com/docs/#/displaying/format/).',
            },
          ],
          examples: [
        ...
        weekday: {
          ...
          args: [
            ...
            },
            {
              name: 'reference',
              description:
                "The reference date to use instead of today, e.g. set this to the note's title.",
            },
            {
              name: 'reference_format',
              description:
    ...
    file: {
      ...
      functions: {
        ...
        create_new: {
          ...
          definition:
            "tp.file.create_new(template: TFile | string, filename: string = 'Untitled', open_new: boolean = false, folder?: TFolder | string)",
          args: [
            {
              name: 'template',
              description:
...
selected value: <% value %>`,
        ...
        suggester: {
          ...
          definition:
            'tp.system.suggester(text_items: string[] | ((item: T) => string), items: T[], throw_on_cancel: boolean = false, placeholder: string = "", limit?: number = undefined, default_value?: T = undefined)',
          args: [
            {
              name: 'text_items',
              description:
...
selected value: <% selectedValue %>`,
        ...
        multi_suggester: {
          ...
          definition:
            'tp.system.multi_suggester(text_items: string[] | ((item: T) => string), items: T[], throw_on_cancel: boolean = false, title: string = "", limit?: number = undefined, default_values?: T[] = undefined)',
          args: [
            {
              name: 'text_items',
              description:
...
var Go = [
  ...
  Vo = new Set(Go)
function Ar(r) {
  return typeof r == 'string' && Vo.has(r)
}
function gi(r) {
  return !!(r.definition || r.returns || r.args)
}
var _r = class {
  constructor(e) {
    this.plugin = e
    this.documentation = di
  }
  get_all_modules_documentation() {
    ...
    return (
      (!this.plugin.settings || !this.plugin.settings.user_scripts_folder) &&
        (t = t.filter((n) => n.name !== 'user')),
      t.map((n) => ((n.queryKey = n.name), n))
    )
  }
  async get_all_functions_documentation(e, t) {
    ...
    if (e === 'user') {
      ...
      let i = zo(t)
      if (i) {
        let a = n.find((l) => l.basename === i.scriptName)
        return a ? Jo(this.plugin, a, i.scriptName) : []
      }
      let o = await ne(
        () => Qr(this.plugin.app, n),
  ...
  get_app_functions_documentation(e, t) {
    ...
    let o = ['tp', 'app', ...n.slice(0, n.length - 1)].join('.'),
    ...
    for (let u in i) {
      ...
      l.push({
        ...
        queryKey: h,
        definition:
          typeof i[u] == 'function' ? `${d}(${Gn(i[u]).join(', ')})` : d,
        description: '',
        returns: '',
        example: '',
      })
...
function zo(r) {
  ...
  if (e === -1) return null
  let t = r.slice(0, e)
  return t ? { scriptName: t } : null
}
async function Jo(r, e, t) {
  let n = await r.app.vault.cachedRead(e),
    i = Wo(n),
    o = new Map(),
    a = new Dt(r)
  await ne(
    () => a.load_user_script_function(e, o),
    `Failed to load user script at "${e.path}"`,
  )
  let l = o.get(t)
  return ct(l)
    ? Object.entries(l)
        .filter((u) => typeof u[1] == 'function')
        .map(([u, d]) => {
          let h = i.get(u) || i.get(d.name)
          return {
            name: u,
            queryKey: `${t}.${u}`,
            definition: `tp.user.${t}.${u}(${Gn(d).join(', ')})`,
...
function Wo(r) {
  let e = new Map(),
    ...
    n = '[$A-Z_a-z][$\\w]*',
    i = [
      new RegExp(`(${t})\\s*(?:async\\s+)?function\\s+(${n})\\s*\\(`, 'g'),
      new RegExp(`(${t})\\s*(?:const|let|var)\\s+(${n})\\s*=`, 'g'),
      new RegExp(`(${t})\\s*(${n})\\s*:`, 'g'),
      new RegExp(`(${t})\\s*["'](${n})["']\\s*:`, 'g'),
      new RegExp(`(${t})\\s*(?:async\\s+)?(${n})\\s*\\([^)]*\\)\\s*{`, 'g'),
      new RegExp(`(${t})\\s*(${n})\\s*(?=,|})`, 'g'),
    ]
  for (let o of i)
    for (let a of r.matchAll(o)) {
      let l = Rn(a[1])
      e.set(a[2], {
        description: l.description,
        returns: l.returns,
...
function mi(r) {
  if (r.length !== 0)
    return r.reduce(
      (e, t) => ((e[t.name] = { name: t.name, description: t.description }), e),
      {},
    )
}
var xr = class extends hi.EditorSuggest {
  constructor(e) {
    super(e.app)
    this.tp_keyword_regex =
      /tp\.(?<module>[a-z]*)?(?<fn_trigger>\.(?<fn>[a-zA-Z_.]*)?)?$/
    this.module_name = ''
    this.function_trigger = !1
    this.function_name = ''
    ;((this.documentation = new _r(e)),
  ...
  onTrigger(e, t, n) {
    ...
    if ((Ar(l) && (this.module_name = l), o.groups && o.groups.fn_trigger)) {
      if (l == '' || !Ar(l)) return null
    ...
    return ((this.latest_trigger_info = u), u)
  }
  async getSuggestions(e) {
    ...
    return (
      ...
      t
        ? t.filter((n) =>
            n.queryKey.toLowerCase().startsWith(e.query.toLowerCase()),
          )
        : []
    )
  }
  renderSuggestion(e, t) {
    let n = gi(e),
      i =
        ...
        Zr(this.intellisense_render_setting),
      o = n && e.returns && Xr(this.intellisense_render_setting),
      a = n && this.function_trigger && e.definition,
      l = e.description && ei(this.intellisense_render_setting),
      u = i || o || a || l
    if ((t.createEl('b', { text: e.name }), u && t.createEl('br'), n)) {
      if (i) {
        t.createEl('p', { text: 'Parameter list:' })
        let d = t.createEl('ol')
        for (let [h, j] of Object.entries(e.args ?? {})) Vn(d, h, j.description)
      }
      o && Vn(t, 'Returns', e.returns)
    }
    ;(a && t.createEl('code', { text: e.definition }),
      l && t.createDiv({ text: e.description }))
  }
  selectSuggestion(e, t) {
    let n = this.app.workspace.activeEditor
    if (
      !(!n || !n.editor) &&
      !!this.latest_trigger_info &&
      ...
      ;((i.ch += e.queryKey.length), n.editor.setCursor(i))
    }
  }
...
;(function (r) {
  ...
  ;(r.defineMode('javascript', function (e, t) {
    ...
    function M(s) {
      for (var c = !1, m, _ = !1; (m = s.next()) != null; ) {
        if (!c) {
          if (m == '/' && !_) return
          m == '[' ? (_ = !0) : _ && m == ']' && (_ = !1)
        }
    ...
    function R(s, c) {
      var m = s.next()
      if (m == '"' || m == "'") return ((c.tokenize = oe(m)), c.tokenize(s, c))
      if (m == '.' && s.match(/^\d[\d_]*(?:[eE][+-]?[\d_]+)?/))
        return D('number', 'number')
      if (m == '.' && s.match('..')) return D('spread', 'meta')
      if (/[[\]{}(),;:.]/.test(m)) return D(m)
      if (m == '=' && s.eat('>')) return D('=>', 'operator')
      if (m == '0' && s.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/))
        return D('number', 'number')
      if (/\d/.test(m))
        return (
      ...
      if (m == '/')
        return s.eat('*')
          ? ((c.tokenize = ae), ae(s, c))
          : s.eat('/')
            ? (s.skipToEnd(), D('comment', 'comment'))
            : qr(s, c, 1)
              ? (M(s),
                s.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/),
                D('regexp', 'string-2'))
              : (s.eat('='), D('operator', 'operator', s.current()))
      if (m == '`') return ((c.tokenize = W), W(s, c))
      if (m == '#' && s.peek() == '!') return (s.skipToEnd(), D('meta', 'meta'))
      if (m == '#' && s.eatWhile(d)) return D('variable', 'property')
      if (
        (m == '<' && s.match('!--')) ||
        (m == '-' && s.match('->') && !/\S/.test(s.string.slice(0, s.start)))
      )
        return (s.skipToEnd(), D('comment', 'comment'))
      if (j.test(m))
        return (
          (m != '>' || !c.lexical || c.lexical.type != '>') &&
            (s.eat('=')
              ? (m == '!' || m == '=') && s.eat('=')
              : /[<>*+\-|&?]/.test(m) && (s.eat(m), m == '>' && s.eat(m))),
          m == '?' && s.eat('.')
            ? D('.')
            : D('operator', 'operator', s.current())
        )
      if (d.test(m)) {
        s.eatWhile(d)
        var _ = s.current()
        if (c.lastType != '.') {
          if (Object.prototype.propertyIsEnumerable.call(h, _)) {
            var C = h[_]
            return D(C.type, C.style, _)
          }
          if (
            _ == 'async' &&
            s.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[[(\w]/, !1)
          )
            return D('async', 'keyword', _)
        }
    ...
    function oe(s) {
      return function (c, m) {
        var _ = !1,
          C
        if (o && c.peek() == '@' && c.match(E))
          return ((m.tokenize = R), D('jsonld-keyword', 'meta'))
        for (; (C = c.next()) != null && !(C == s && !_); ) _ = !_ && C == '\\'
        return (_ || (m.tokenize = R), D('string', 'string'))
      }
    }
    function ae(s, c) {
      for (var m = !1, _; (_ = s.next()); ) {
        if (_ == '/' && m) {
          c.tokenize = R
          break
        }
    ...
    function W(s, c) {
      ...
      return D('quasi', 'string-2', s.current())
    }
    var Ue = '([{}])'
    function fe(s, c) {
      c.fatArrowAt && (c.fatArrowAt = null)
      var m = s.string.indexOf('=>', s.start)
      if (!(m < 0)) {
        if (u) {
          var _ = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(
            s.string.slice(s.start, m),
          )
          _ && (m = _.index)
        }
        for (var C = 0, O = !1, H = m - 1; H >= 0; --H) {
          var te = s.string.charAt(H),
            xe = Ue.indexOf(te)
          if (xe >= 0 && xe < 3) {
            if (!C) {
              ++H
          ...
          else if (d.test(te)) O = !0
          else if (/["'/`]/.test(te))
            for (; ; --H) {
              if (H == 0) return
              var Ri = s.string.charAt(H - 1)
              if (Ri == te && s.string.charAt(H - 2) != '\\') {
                H--
                break
              }
            }
    ...
    function jn(s, c) {
      if (!l) return !1
      for (var m = s.localVars; m; m = m.next) if (m.name == c) return !0
      for (var _ = s.context; _; _ = _.prev)
        for (m = _.vars; m; m = m.next) if (m.name == c) return !0
    }
    function mt(s, c, m, _, C) {
      var O = s.cc
      for (
        A.state = s,
          A.stream = C,
          ...
          A.cc = O,
          A.style = c,
          Object.prototype.hasOwnProperty.call(s.lexical, 'align') ||
            (s.lexical.align = !0);
        ;
      ) {
        var H = O.length ? O.pop() : a ? U : X
        if (H(m, _)) {
    ...
    function k() {
      for (var s = arguments.length - 1; s >= 0; s--) A.cc.push(arguments[s])
    }
    function f() {
      return (k.apply(null, arguments), !0)
    }
    function wn(s, c) {
      for (var m = c; m; m = m.next) if (m.name == s) return !0
      return !1
    }
    function Qe(s) {
      var c = A.state
      if (((A.marked = 'def'), !!l)) {
        if (c.context) {
          if (c.lexical.info == 'var' && c.context && c.context.block) {
            var m = br(s, c.context)
            if (m != null) {
              c.context = m
              return
            }
          } else if (!wn(s, c.localVars)) {
            c.localVars = new At(s, c.localVars)
            return
          }
        }
        t.globalVars &&
          !wn(s, c.globalVars) &&
          (c.globalVars = new At(s, c.globalVars))
      }
    }
    function br(s, c) {
      if (c)
        if (c.block) {
          var m = br(s, c.prev)
          return m ? (m == c.prev ? c : new ht(m, c.vars, !0)) : null
        } else return wn(s, c.vars) ? c : new ht(c.prev, new At(s, c.vars), !1)
      else return null
    }
    function Mt(s) {
      return (
    ...
    function ht(s, c, m) {
      ;((this.prev = s), (this.vars = c), (this.block = m))
    }
    function At(s, c) {
      ;((this.name = s), (this.next = c))
    }
    var yi = new At('this', new At('arguments', null))
    function Xe() {
      ;((A.state.context = new ht(A.state.context, A.state.localVars, !1)),
        (A.state.localVars = yi))
    }
    function vn() {
      ;((A.state.context = new ht(A.state.context, A.state.localVars, !0)),
    ...
    function N(s, c) {
      var m = function () {
        var _ = A.state,
          C = _.indented
        if (_.lexical.type == 'stat') C = _.lexical.indented
        else
          for (var O = _.lexical; O && O.type == ')' && O.align; O = O.prev)
            C = O.indented
        _.lexical = new Nt(C, A.stream.column(), s, null, _.lexical, c)
      }
      return ((m.lex = !0), m)
    }
    function S() {
                  ...
                  : s == ';'
                    ...
                    : s == 'if'
                      ? (A.state.lexical.info == 'else' &&
                          A.state.cc[A.state.cc.length - 1] == S &&
                          A.state.cc.pop()(),
                        f(N('form'), Tn, X, S, Pr))
                      : s == 'function'
                        ? f(Be)
                        : s == 'for'
                          ? f(N('form'), vn, Nr, X, de, S)
                          : s == 'class' || (u && c == 'interface')
                            ? ((A.marked = 'keyword'),
                              f(N('form', s == 'class' ? s : c), Fr, S))
                            : s == 'variable'
                              ? u && c == 'declare'
                                ? ((A.marked = 'keyword'), f(X))
                                : u &&
                                    (c == 'module' ||
                                      c == 'enum' ||
                                      c == 'type') &&
                                    A.stream.match(/^\s*\w/, !1)
                                  ? ((A.marked = 'keyword'),
                                    c == 'enum'
                                      ? f(Or)
                                      : c == 'type'
    ...
    function Tn(s) {
      return s != '(' ? k() : f(N(')'), Ze, B(')'), S)
    }
    function Er(s, c, m) {
      if (A.state.fatArrowAt == A.stream.start) {
        var _ = m ? Sr : kr
        if (s == '(') return f(Xe, N(')'), Z(Ge, ')'), S, B('=>'), _, de)
        if (s == 'variable') return k(Xe, ge, B('=>'), _, de)
      }
      var C = m ? et : Ye
      return Object.prototype.hasOwnProperty.call(yn, s)
        ? f(C)
        : s == 'function'
          ? f(Be, C)
          : s == 'class' || (u && c == 'interface')
            ? ((A.marked = 'keyword'), f(N('form'), qi, S))
            : s == 'keyword c' || s == 'async'
              ? f(m ? se : U)
              : s == '('
                ? f(N(')'), Ze, B(')'), S, C)
    ...
    function Ze(s) {
      return s.match(/[;})\],]/) ? k() : k(U)
    }
    function Ye(s, c) {
      return s == ',' ? f(Ze) : et(s, c, !1)
    }
    function et(s, c, m) {
      var _ = m == !1 ? Ye : et,
        C = m == !1 ? U : se
      if (s == '=>') return f(Xe, m ? Sr : kr, de)
      if (s == 'operator')
        return /\+\+|--/.test(c) || (u && c == '!')
          ? f(_)
          : u && c == '<' && A.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
            ? f(N('>'), Z($, '>'), S, _)
            : c == '?'
              ? f(U, B(':'), C)
              : f(C)
      if (s == 'quasi') return k(Ft, _)
      if (s != ';') {
        if (s == '(') return _t(se, ')', 'call', _)
        if (s == '.') return f(ki, _)
        if (s == '[') return f(N(']'), Ze, B(']'), S, _)
        if (u && c == 'as') return ((A.marked = 'keyword'), f($, _))
        if (s == 'regexp')
          return (
    ...
    function wi(s) {
      if (s == '}')
        return ((A.marked = 'string-2'), (A.state.tokenize = W), f(Ft))
    }
    function kr(s) {
      return (fe(A.stream, A.state), k(s == '{' ? X : U))
    }
    function Sr(s) {
      return (fe(A.stream, A.state), k(s == '{' ? X : se))
    }
    function vi(s) {
      return function (c) {
        return c == '.'
    ...
    function Ti(s, c) {
      if (c == 'target') return ((A.marked = 'keyword'), f(Ye))
    }
    function bi(s, c) {
      if (c == 'target') return ((A.marked = 'keyword'), f(et))
    }
    function Ei(s) {
      return s == ':' ? f(S, X) : k(Ye, B(';'), S)
    }
    function ki(s) {
      if (s == 'variable') return ((A.marked = 'property'), f())
    }
    function It(s, c) {
      if (s == 'async') return ((A.marked = 'property'), f(It))
      if (s == 'variable' || A.style == 'keyword') {
        if (((A.marked = 'property'), c == 'get' || c == 'set')) return f(Si)
        var m
        return (
          u &&
            A.state.fatArrowAt == A.stream.start &&
            (m = A.stream.match(/^\s*:\s*/, !1)) &&
            (A.state.fatArrowAt = A.stream.pos + m[0].length),
          f(Re)
        )
      } else {
        if (s == 'number' || s == 'string')
          return ((A.marked = o ? 'property' : A.style + ' property'), f(Re))
        if (s == 'jsonld-keyword') return f(Re)
        if (u && Mt(c)) return ((A.marked = 'keyword'), f(It))
        if (s == '[') return f(U, tt, B(']'), Re)
        if (s == 'spread') return f(se, Re)
        if (c == '*') return ((A.marked = 'keyword'), f(It))
        if (s == ':') return k(Re)
      }
    }
    function Si(s) {
      return s != 'variable' ? k(Re) : ((A.marked = 'property'), f(Be))
    }
    function Re(s) {
      if (s == ':') return f(se)
      if (s == '(') return k(Be)
    ...
    function Z(s, c, m) {
      function _(C, O) {
        if (m ? m.indexOf(C) > -1 : C == ',') {
          var H = A.state.lexical
          return (
            H.info == 'call' && (H.pos = (H.pos || 0) + 1),
            f(function (te, xe) {
              return te == c || xe == c ? k() : k(s)
            }, _)
          )
        }
        return C == c || O == c
      ...
      return function (C, O) {
        return C == c || O == c ? f() : k(s, _)
      }
    }
    function _t(s, c, m) {
      for (var _ = 3; _ < arguments.length; _++) A.cc.push(arguments[_])
      return f(N(c, m), Z(s, c), S)
    }
    function Bt(s) {
      return s == '}' ? f() : k(X, Bt)
    }
    ...
    function Ci(s, c) {
      if (u && (s == ':' || c == 'in')) return f($)
    }
    function Cr(s) {
      if (u && s == ':')
        return A.stream.match(/^\s*\w+\s+is\b/, !1) ? f(U, Di, $) : f($)
    }
    function Di(s, c) {
      if (c == 'is') return ((A.marked = 'keyword'), f())
    }
    function $(s, c) {
      if (c == 'keyof' || c == 'typeof' || c == 'infer' || c == 'readonly')
        return ((A.marked = 'keyword'), f(c == 'typeof' ? se : $))
      if (s == 'variable' || c == 'void') return ((A.marked = 'type'), f(be))
      if (c == '|' || c == '&') return f($)
      if (s == 'string' || s == 'number' || s == 'atom') return f(be)
      if (s == '[') return f(N(']'), Z($, ']', ','), S, be)
      if (s == '{') return f(N('}'), bn, S, be)
      if (s == '(') return f(Z(kn, ')'), Pi, be)
      if (s == '<') return f(Z($, '>'), $)
      if (s == 'quasi') return k(En, be)
    }
    function Pi(s) {
      if (s == '=>') return f($)
    }
    function bn(s) {
      return s.match(/[})\]]/) ? f() : s == ',' || s == ';' ? f(bn) : k(xt, bn)
    }
    function xt(s, c) {
      if (s == 'variable' || A.style == 'keyword')
        return ((A.marked = 'property'), f(xt))
      if (c == '?' || s == 'number' || s == 'string') return f(xt)
      if (s == ':') return f($)
      if (s == '[') return f(B('variable'), Ci, B(']'), xt)
      if (s == '(') return k(rt, xt)
      if (!s.match(/[;})\],]/)) return f()
    }
    function En(s, c) {
    ...
    function Ni(s) {
      if (s == '}')
        return ((A.marked = 'string-2'), (A.state.tokenize = W), f(En))
    }
    function kn(s, c) {
      return (s == 'variable' && A.stream.match(/^\s*[?:]/, !1)) || c == '?'
        ? f(kn)
        : s == ':'
          ? f($)
          : s == 'spread'
    ...
    function be(s, c) {
      if (c == '<') return f(N('>'), Z($, '>'), S, be)
      if (c == '|' || s == '.' || c == '&') return f($)
      if (s == '[') return f($, B(']'), be)
      if (c == 'extends' || c == 'implements')
        return ((A.marked = 'keyword'), f($))
      if (c == '?') return f($, B(':'), $)
    }
    function Mi(s, c) {
      if (c == '<') return f(N('>'), Z($, '>'), S, be)
    ...
    function Sn(s, c) {
      return c == 'enum' ? ((A.marked = 'keyword'), f(Or)) : k(ge, tt, Ie, Bi)
    }
    function ge(s, c) {
      if (u && Mt(c)) return ((A.marked = 'keyword'), f(ge))
      if (s == 'variable') return (Qe(c), f())
      if (s == 'spread') return f(ge)
      if (s == '[') return _t(Ii, ']')
      if (s == '{') return _t(Dr, '}')
    }
    function Dr(s, c) {
      return s == 'variable' && !A.stream.match(/^\s*:/, !1)
        ? (Qe(c), f(Ie))
        : (s == 'variable' && (A.marked = 'property'),
          s == 'spread'
            ? f(ge)
            : s == '}'
              ? k()
    ...
    function Pr(s, c) {
      if (s == 'keyword b' && c == 'else') return f(N('form', 'else'), X, S)
    }
    function Nr(s, c) {
      if (c == 'await') return f(Nr)
      if (s == '(') return f(N(')'), Oi, S)
    }
    function Oi(s) {
      return s == 'var' ? f(Sn, nt) : s == 'variable' ? f(nt) : k(nt)
    }
    function nt(s, c) {
      return s == ')'
        ? f()
        : s == ';'
          ? f(nt)
          : c == 'in' || c == 'of'
            ? ((A.marked = 'keyword'), f(U, nt))
            : k(U, nt)
    }
    function Be(s, c) {
      if (c == '*') return ((A.marked = 'keyword'), f(Be))
      if (s == 'variable') return (Qe(c), f(Be))
      if (s == '(') return f(Xe, N(')'), Z(Ge, ')'), S, Cr, X, de)
      if (u && c == '<') return f(N('>'), Z(Ot, '>'), S, Be)
    }
    function rt(s, c) {
      if (c == '*') return ((A.marked = 'keyword'), f(rt))
      if (s == 'variable') return (Qe(c), f(rt))
      if (s == '(') return f(Xe, N(')'), Z(Ge, ')'), S, Cr, de)
      if (u && c == '<') return f(N('>'), Z(Ot, '>'), S, rt)
    }
    function Mr(s, c) {
      if (s == 'keyword' || s == 'variable') return ((A.marked = 'type'), f(Mr))
      if (c == '<') return f(N('>'), Z(Ot, '>'), S)
    }
    function Ge(s, c) {
      return (
        c == '@' && f(U, Ge),
    ...
    function qi(s, c) {
      return s == 'variable' ? Fr(s, c) : qt(s, c)
    }
    function Fr(s, c) {
      if (s == 'variable') return (Qe(c), f(qt))
    }
    function qt(s, c) {
      if (c == '<') return f(N('>'), Z(Ot, '>'), S, qt)
      if (c == 'extends' || c == 'implements' || (u && s == ','))
        return (c == 'implements' && (A.marked = 'keyword'), f(u ? $ : U, qt))
      if (s == '{') return f(N('}'), Ee, S)
    }
    function Ee(s, c) {
      if (
        s == 'async' ||
        (s == 'variable' &&
          (c == 'static' || c == 'get' || c == 'set' || (u && Mt(c))) &&
          A.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
      )
        return ((A.marked = 'keyword'), f(Ee))
      if (s == 'variable' || A.style == 'keyword')
        return ((A.marked = 'property'), f(yt, Ee))
      if (s == 'number' || s == 'string') return f(yt, Ee)
      if (s == '[') return f(U, tt, B(']'), yt, Ee)
      if (c == '*') return ((A.marked = 'keyword'), f(Ee))
      if (u && s == '(') return k(rt, Ee)
      if (s == ';' || s == ',') return f(Ee)
      if (s == '}') return f()
      if (c == '@') return f(U, Ee)
    }
    function yt(s, c) {
      ...
      if (s == ':') return f($, Ie)
      if (c == '=') return f(se)
      var m = A.state.lexical.prev,
        _ = m && m.info == 'interface'
      return k(_ ? rt : Be)
    }
    function Li(s, c) {
      return c == '*'
        ? ((A.marked = 'keyword'), f(Cn, B(';')))
        : c == 'default'
          ? ((A.marked = 'keyword'), f(U, B(';')))
          : s == '{'
            ? f(Z(Ir, '}'), Cn, B(';'))
            : k(X)
    }
    function Ir(s, c) {
      if (c == 'as') return ((A.marked = 'keyword'), f(B('variable')))
      if (s == 'variable') return k(se, Ir)
    }
    function $i(s) {
      return s == 'string'
        ? f()
    ...
    function Lt(s, c) {
      return s == '{'
        ? _t(Lt, '}')
        : (s == 'variable' && Qe(c), c == '*' && (A.marked = 'keyword'), f(Hi))
    }
    function Br(s) {
      if (s == ',') return f(Lt, Br)
    }
    function Hi(s, c) {
      if (c == 'as') return ((A.marked = 'keyword'), f(Lt))
    }
    function Cn(s, c) {
      if (c == 'from') return ((A.marked = 'keyword'), f(U))
    }
    function Ki(s) {
      return s == ']' ? f() : k(Z(se, ']'))
    }
    function Or() {
      return k(N('form'), ge, B('{'), N('}'), Z(Ui, '}'), S, S)
    }
    function Ui() {
      return k(ge, Ie)
    }
    ...
    function qr(s, c, m) {
      return (
        ...
        (c.lastType == 'quasi' &&
          /\{\s*$/.test(s.string.slice(0, s.pos - (m || 0))))
      )
    }
    return {
      startState: function (s) {
        var c = {
          ...
          lastType: 'sof',
          cc: [],
          lexical: new Nt((s || 0) - n, 0, 'block', !1),
          localVars: t.localVars,
          context: t.localVars && new ht(null, null, !1),
          indented: s || 0,
        }
        return (
          t.globalVars &&
            typeof t.globalVars == 'object' &&
            (c.globalVars = t.globalVars),
          c
        )
      },
      token: function (s, c) {
        if (
          (s.sol() &&
            (Object.prototype.hasOwnProperty.call(c.lexical, 'align') ||
              (c.lexical.align = !1),
            (c.indented = s.indentation()),
            fe(s, c)),
          c.tokenize != ae && s.eatSpace())
        )
          return null
        var m = c.tokenize(s, c)
        return I == 'comment'
          ? m
          : ((c.lastType =
              I == 'operator' && (K == '++' || K == '--') ? 'incdec' : I),
            mt(c, m, I, K, s))
      },
      indent: function (s, c) {
        if (s.tokenize == ae || s.tokenize == W) return r.Pass
        if (s.tokenize != R) return 0
        var m = c && c.charAt(0),
          _ = s.lexical,
          C
        if (!/^\s*else\b/.test(c))
          for (var O = s.cc.length - 1; O >= 0; --O) {
            var H = s.cc[O]
            if (H == S) _ = _.prev
            else if (H != Pr && H != de) break
          }
        for (
          ;
          (_.type == 'stat' || _.type == 'form') &&
          (m == '}' ||
            ((C = s.cc[s.cc.length - 1]) &&
              (C == Ye || C == et) &&
              !/^[,.=+\-*:?[(]/.test(c)));
        )
          _ = _.prev
        ...
        return te == 'vardef'
          ...
          : te == 'form' && m == '{'
            ...
            : te == 'form'
              ? _.indented + n
              : te == 'stat'
                ? _.indented + (Yi(s, c) ? i || n : 0)
                : _.info == 'switch' && !xe && t.doubleIndentSwitch != !1
                  ? _.indented + (/^(?:case|default)\b/.test(c) ? n : 2 * n)
                  : _.align
                    ? _.column + (xe ? 0 : 1)
                    : _.indented + (xe ? 0 : n)
      },
      ...
      jsonldMode: o,
      jsonMode: a,
      expressionAllowed: qr,
      skipExpression: function (s) {
        mt(s, 'atom', 'atom', 'true', new r.StringStream('', 2, null))
      },
    }
  }),
  ...
  r.customOverlayMode = function (e, t, n) {
    return {
      ...
      copyState: function (i) {
        return {
          base: r.copyState(e, i.base),
          overlay: r.copyState(t, i.overlay),
          basePos: i.basePos,
          baseCur: null,
        ...
        return (
          ...
          o.overlayCur == null
            ...
            : (o.baseCur != null && o.overlay.combineTokens) ||
                (n && o.overlay.combineTokens == null)
      ...
      blankLine: function (i) {
        ...
        return (
          ...
          a == null ? o : n && o != null ? o + ' ' + a : a
        )
      },
    }
  }
})
var Ai = G(require('@codemirror/language')),
  _i = G(require('@codemirror/state')),
  xi = 'templater',
  jr = 'templater-command',
  wr = 'templater-inline',
  Qo = 'templater-opening-tag',
  Xo = 'templater-closing-tag',
  Zo = 'templater-interpolation-tag',
  ea = 'templater-execution-tag',
  vr = class {
    constructor(e) {
      this.plugin = e
      ;((this.cursor_jumper = new hr(e.app)),
        (this.activeEditorExtensions = []))
    }
    desktopShouldHighlight() {
      return (
        yr.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting
      )
    }
    mobileShouldHighlight() {
      return (
        yr.Platform.isMobile && this.plugin.settings.syntax_highlighting_mobile
      )
    }
    async setup() {
      ;((this.autocomplete = new xr(this.plugin)),
        this.plugin.registerEditorSuggest(this.autocomplete),
        await this.registerCodeMirrorMode(),
        (this.templaterLanguage = _i.Prec.high(
          Ai.StreamLanguage.define(window.CodeMirror.getMode({}, xi)),
        )),
      ...
      window.CodeMirror.defineMode(xi, function (n) {
        let i = {
          ...
          copyState: function (o) {
            let a = window.CodeMirror.startState(e),
              l = o
            return {
              ...a,
              inCommand: l.inCommand,
              tag_class: l.tag_class,
              freeLine: l.freeLine,
            }
          },
          ...
          token: function (o, a) {
            let l = a
            if ((o.sol() && l.inCommand && (l.freeLine = !0), l.inCommand)) {
              let d = ''
              if (o.match(/[-_]{0,1}%>/, !0)) {
                ;((l.inCommand = !1), (l.freeLine = !1))
                let j = l.tag_class
                return ((l.tag_class = ''), `line-${wr} ${jr} ${Xo} ${j}`)
              }
              let h = e.token && e.token(o, l)
              return (
                o.peek() == null &&
                  l.freeLine &&
                  (d += ' line-background-templater-command-bg'),
                l.freeLine || (d += ` line-${wr}`),
                `${d} ${jr} ${h}`
              )
            }
            let u = o.match(/<%[-_]{0,1}\s*([*+]{0,1})/, !0)
            if (u) {
              switch (u[1]) {
                case '*':
                  l.tag_class = ea
        ...
        return t(window.CodeMirror.getMode(n, 'hypermd'), i)
      })
    }
...
var Tr = class extends xn.Plugin {
  async onload() {
    ;(await this.load_settings(),
      (this.templater = new dt(this)),
      await this.templater.setup(),
      (this.editor_handler = new vr(this)),
      await this.editor_handler.setup(),
      (this.fuzzy_suggester = new Jn(this)),
      (this.event_handler = new _n(this, this.templater, this.settings)),
      await this.event_handler.setup(),
      (this.command_handler = new gr(this)),
      this.command_handler.setup(),
      (0, xn.addIcon)('templater-icon', ri),
      this.addRibbonIcon('templater-icon', 'Templater', () => {
        this.fuzzy_suggester.insert_template()
      }).setAttribute('id', 'rb-templater-icon'),
      this.addSettingTab(new zn(this)),
  ...
  async load_settings() {
    this.settings = Object.assign({}, ti, await this.loadData())
  }
}
