    ...
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let r of ba(e))
        !Ta.call(n, r) &&
          ...
          Rn(n, r, {
            get: () => e[r],
            enumerable: !(t = wa(e, r)) || t.enumerable,
          })
    return n
  },
  X = (n) =>
  ...
  xt = (function (n) {
    ...
    return (
      ...
      (e.prototype.appendNodeInParagraph = function (t) {
        ...
        ;(r ||
          ((r = new st({ configuration: this.configuration })),
          this.appendNode(r)),
          r.appendNode(t))
      }),
  ...
  Wt = (function (n) {
    ...
    function e(t) {
      ...
      return (
        ...
        (r._content = new xt({ configuration: r.configuration })),
        r
      )
    }
    return (
  ...
  return (
    ...
    (n.prototype._parseInlineTag = function (e) {
      ...
      var w = e.extractAccumulatedSequence(),
        ...
        k = new $r(
          this._parserContext,
          _ || yt.createEmpty(this._parserContext),
        ),
        E
      switch (S) {
...
function Le(n) {
  for (var e = Z(n), t = ho(n); t && Wr(t) && we(t).position === 'static'; )
    t = ho(t)
  return t &&
...
;(function (n) {
  ...
  ;(n.defineMode('javascript', function (e, t) {
    ...
    function qi(s) {
      if (c && s == ':')
        return h.stream.match(/^\s*\w+\s+is\b/, !1) ? f(W, aa, V) : f(V)
    }
    function aa(s, p) {
  ...
  Ii = class {
    ...
    async setup() {
      ;((this.autocomplete = new Ni(this.plugin)),
        ...
        (this.templaterLanguage = ra.Prec.high(
          na.StreamLanguage.define(window.CodeMirror.getMode({}, ia)),
        )),
