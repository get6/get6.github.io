...
var Yi = (n) => Hn(n, '__esModule', { value: !0 })
var va = (n, e) => {
    Yi(n)
    for (var t in e) Hn(n, t, { get: e[t], enumerable: !0 })
  },
  wa = (n, e, t) => {
...
async function Te(n, e) {
  try {
    ...
    return (t instanceof N ? oe(t) : oe(new N(e, t.message)), null)
  }
}
function ke(n, e) {
  try {
    ...
    return (oe(new N(e, t.message)), null)
  }
}
var re = (function () {
  function n() {}
  ...
  return (
    (n.register = function (e) {
      ...
      ;(t.registerDocNodes('@microsoft/tsdoc', [
        ...
        { docNodeKind: g.BlockTag, constructor: $n },
        { docNodeKind: g.CodeSpan, constructor: Kn },
        { docNodeKind: g.Comment, constructor: Rn },
        { docNodeKind: g.DeclarationReference, constructor: Yn },
        { docNodeKind: g.ErrorText, constructor: St },
        { docNodeKind: g.EscapedText, constructor: Un },
        { docNodeKind: g.Excerpt, constructor: j },
        { docNodeKind: g.FencedCode, constructor: Gn },
        { docNodeKind: g.HtmlAttribute, constructor: Wn },
        { docNodeKind: g.HtmlEndTag, constructor: Vn },
        ...
        { docNodeKind: g.LinkTag, constructor: Jn },
        { docNodeKind: g.MemberIdentifier, constructor: fn },
        { docNodeKind: g.MemberReference, constructor: Qn },
        { docNodeKind: g.MemberSelector, constructor: Xn },
        { docNodeKind: g.MemberSymbol, constructor: Zn },
        ...
        { docNodeKind: g.SoftBreak, constructor: er },
      ]),
...
var Fr = (function () {
  function n(e, t) {
    ;((this.commentRange = We.empty),
      ...
      (this.sourceRange = t),
      (this.docComment = new Rn({ configuration: this.configuration })),
      (this.log = new Br()))
  }
  return n
})()
...
var Zi = (function () {
  ...
  return (
    ...
    (n.prototype._performValidationChecks = function () {
      ...
      ;(e.deprecatedBlock &&
        (or.hasAnyTextContent(e.deprecatedBlock) ||
        ...
        e.inheritDocTag &&
          ...
          or.hasAnyTextContent(e.summarySection) &&
    ...
    (n.prototype._parseBackslashEscape = function (e) {
      ...
      return new Un({
        parsed: !0,
        configuration: this._configuration,
        escapeStyle: ir.CommonMarkBackslash,
...
function Za(n, e) {
  ...
  if (!t) throw new N(`Folder "${e}" doesn't exist`)
  if (!(t instanceof Ve.TFolder)) throw new N(`${e} is a file, not a folder`)
  return t
}
function Dt(n, e) {
  e = (0, Ve.normalizePath)(e)
  let t = n.vault.getAbstractFileByPath(e)
  if (!t) throw new N(`File "${e}" doesn't exist`)
  if (!(t instanceof Ve.TFile)) throw new N(`${e} is a folder, not a file`)
  return t
}
function ze(n, e) {
  let t = Za(n, e),
...
function go(n) {
  ...
  if (d) {
    ...
    if (
      ...
      C = ue
      var ne = y && I === H && H.visualViewport ? H.visualViewport.height : I[J]
...
function qe(n, e) {
  ...
  var t = e,
    ...
    k = t.padding,
    w = k === void 0 ? 0 : k,
    M = jn(typeof w != 'number' ? w : vn(w, yt)),
    $ = b === Qt ? co : Qt,
    K = n.rects.popper,
    C = n.elements[P ? $ : b],
    H = Wr(De(C) ? C : C.contextElement || he(n.elements.popper), c, m, a),
    I = Pe(n.elements.reference),
    J = wn({ reference: I, element: K, strategy: 'absolute', placement: i }),
...
var bo = { name: 'popperOffsets', enabled: !0, phase: 'read', fn: Ns, data: {} }
function zr(n) {
  return n === 'x' ? 'y' : 'x'
}
function Os(n) {
  ...
  if (!!I) {
    if (o) {
      var f,
        ...
        Cn = bt ? (C === 'y' ? bt.clientTop || 0 : bt.clientLeft || 0) : 0,
    ...
    if (l) {
      var Dn,
        ...
        Tt = (Dn = h == null ? void 0 : h[H]) != null ? Dn : 0,
        Bn = an ? On : rt - J[Kt] - te[Kt] - Tt + Q.altAxis,
        Ye = an ? rt + J[Kt] + te[Kt] - Tt - Q.altAxis : Mn,
        se = E && an ? fo(Bn, rt, Ye) : Ft(E ? Bn : On, rt, E ? Ye : Mn)
      ;((I[H] = se), (S[H] = se - rt))
    }
    e.modifiersData[r] = S
  }
            ...
            if (!!ko($, K)) {
              ...
              for (var C = 0; C < m.orderedModifiers.length; C++) {
                ...
                var H = m.orderedModifiers[C],
                  ...
                  ne = H.name
                typeof I == 'function' &&
                  (m = I({ state: m, options: te, name: ne, instance: E }) || m)
              }
            }
          }
        },
...
var En = class extends bn {
  ...
  getSuggestions(e) {
    ...
    return (
      t.forEach((o) => {
        o instanceof No.TFolder && o.path.toLowerCase().contains(i) && r.push(o)
      }),
      r.slice(0, 1e3)
    )
  }
                ...
                o
                  ...
                  .onChange((a) => {
                    if (
                      ...
                      oe(new N('This template is already bound to a hotkey'))
                      return
                    }
                ...
                o
                  ...
                  .onChange((a) => {
                    if (
                      ...
                      oe(new N('This startup template already exist'))
                      return
                    }
          ...
          .addText((o) => {
            o.setPlaceholder('Timeout')
              ...
              .onChange((a) => {
                let l = Number(a)
                if (isNaN(l)) {
                  oe(new N('Timeout must be a number'))
                  return
                }
  ...
  ai = class extends we {
    ...
    generate_create_new() {
      return async (e, t, r = !1, i) => {
        if (((this.create_new_depth += 1), this.create_new_depth > Lo))
          throw (
            (this.create_new_depth = 0),
            new N('Reached create_new depth limit (max = 10)')
          )
    ...
    generate_cursor_append() {
      return (e) => {
        ...
        if (!t || !t.editor) {
          oe(new N("No active editor, can't append to cursor."))
          return
        }
      ...
      return async (e) => {
        if (((this.include_depth += 1), this.include_depth > Lo))
          throw (
            ...
            new N('Reached inclusion depth limit (max = 10)')
          )
        let t
        if (e instanceof le.TFile) t = await this.plugin.app.vault.read(e)
          ...
          if (!a)
            throw ((this.include_depth -= 1), new N(`File ${e} doesn't exist`))
    ...
    generate_path() {
      return (e = !1) => {
        ...
        else throw new N('app.vault is not a FileSystemAdapter instance')
        return e
    ...
    generate_selection() {
      return () => {
        ...
        if (!e || !e.editor)
          throw new N("Active editor is null, can't read selection.")
  ...
  async getRequest(e) {
    try {
      ...
      if (t.status < 200 && t.status >= 300)
        throw new N('Error performing GET request')
      return t
    } catch {
      throw new N('Error performing GET request')
    }
...
> \u2014 ${o}`
        ...
        return (
          new N('Error generating daily quote'),
  ...
  generate_random_picture() {
    return async (e, t, r = !1) => {
      try {
        ...
        return (
          new N('Error generating random picture'),
  ...
  generate_request() {
    return async (e, t) => {
      try {
        ...
        throw (console.error(r), new N('Error fetching and extracting value'))
      }
    }
  }
}
...
var pi = class extends Je.Modal {
  ...
  onClose() {
    ;(this.contentEl.empty(),
      this.submitted || this.reject(new N('Cancelled prompt')))
  }
  createForm() {
...
var Tn = X(require('obsidian'))
var gi = class {
  constructor(e) {
    this.plugin = e
    if (
      Tn.Platform.isMobile ||
      !(this.plugin.app.vault.adapter instanceof Tn.FileSystemAdapter)
    )
      this.cwd = ''
    else {
          ...
          : ((a = await this.plugin.templater.parser.parse_commands(a, r)),
            t.set(o, async (l) => {
              ...
              try {
                ...
                throw new N(`Error with User Template ${o}`, m)
              }
            })))
    }
    return t
...
var hi = class {
  ...
  async load_user_script_function(e, t) {
    ...
    try {
      ...
      throw new N(`Failed to load user script at "${e.path}".`, c.message)
    }
...
function gr() {
  return (mr.byteLength === 0 && (mr = new Uint8Array(O.memory.buffer)), mr)
}
function vt(n, e) {
  return Ko.decode(gr().subarray(n, n + e))
}
function wt(n) {
  kn === He.length && He.push(He.length + 1)
  let e = kn
  return ((kn = He[e]), (He[e] = n), e)
}
var $e = 0,
...
function Ce() {
  return (Ar.byteLength === 0 && (Ar = new Int32Array(O.memory.buffer)), Ar)
}
function yi(n) {
  let e = typeof n
...
var Ht = class {
    ...
    free() {
      ...
      O.__wbg_parserconfig_free(e)
    }
    get interpolate() {
      let e = O.__wbg_get_parserconfig_interpolate(this.ptr)
      return String.fromCodePoint(e)
    }
    set interpolate(e) {
      O.__wbg_set_parserconfig_interpolate(this.ptr, e.codePointAt(0))
    }
    get execution() {
      let e = O.__wbg_get_parserconfig_execution(this.ptr)
      return String.fromCodePoint(e)
    }
    set execution(e) {
      O.__wbg_set_parserconfig_execution(this.ptr, e.codePointAt(0))
    }
    get single_whitespace() {
      let e = O.__wbg_get_parserconfig_single_whitespace(this.ptr)
      return String.fromCodePoint(e)
    }
    set single_whitespace(e) {
      O.__wbg_set_parserconfig_single_whitespace(this.ptr, e.codePointAt(0))
    }
    get multiple_whitespace() {
      let e = O.__wbg_get_parserconfig_multiple_whitespace(this.ptr)
      return String.fromCodePoint(e)
    }
    set multiple_whitespace(e) {
      O.__wbg_set_parserconfig_multiple_whitespace(this.ptr, e.codePointAt(0))
    }
    constructor(e, t, r, i, o, a, l) {
      let c = mt(e, O.__wbindgen_malloc, O.__wbindgen_realloc),
        d = $e,
        m = mt(t, O.__wbindgen_malloc, O.__wbindgen_realloc),
        y = $e,
        b = mt(l, O.__wbindgen_malloc, O.__wbindgen_realloc),
        E = $e,
        P = O.parserconfig_new(
          c,
          d,
          m,
          y,
    ...
    get opening_tag() {
      try {
        ...
        O.parserconfig_opening_tag(r, this.ptr)
        var e = Ce()[r / 4 + 0],
          t = Ce()[r / 4 + 1]
        return vt(e, t)
      } finally {
        ;(O.__wbindgen_add_to_stack_pointer(16), O.__wbindgen_free(e, t))
      }
    }
    set opening_tag(e) {
      let t = mt(e, O.__wbindgen_malloc, O.__wbindgen_realloc),
        r = $e
      O.parserconfig_set_opening_tag(this.ptr, t, r)
    }
    get closing_tag() {
      try {
        let r = O.__wbindgen_add_to_stack_pointer(-16)
        O.parserconfig_closing_tag(r, this.ptr)
        var e = Ce()[r / 4 + 0],
          t = Ce()[r / 4 + 1]
        return vt(e, t)
      } finally {
    ...
    set closing_tag(e) {
      let t = mt(e, O.__wbindgen_malloc, O.__wbindgen_realloc),
        r = $e
      O.parserconfig_set_closing_tag(this.ptr, t, r)
    }
    get global_var() {
      try {
        let r = O.__wbindgen_add_to_stack_pointer(-16)
        O.parserconfig_global_var(r, this.ptr)
        var e = Ce()[r / 4 + 0],
          t = Ce()[r / 4 + 1]
        return vt(e, t)
      } finally {
    ...
    set global_var(e) {
      let t = mt(e, O.__wbindgen_malloc, O.__wbindgen_realloc),
        r = $e
      O.parserconfig_set_global_var(this.ptr, t, r)
    }
  },
  on = class {
    static __wrap(e) {
    ...
    free() {
      let e = this.__destroy_into_raw()
      O.__wbg_renderer_free(e)
    }
    constructor(e) {
      Ks(e, Ht)
      var t = e.ptr
      e.ptr = 0
      let r = O.renderer_new(t)
      return on.__wrap(r)
    }
    render_content(e, t) {
      try {
        let a = O.__wbindgen_add_to_stack_pointer(-16),
          l = mt(e, O.__wbindgen_malloc, O.__wbindgen_realloc),
          c = $e
        O.renderer_render_content(a, this.ptr, l, c, Rs(t))
        var r = Ce()[a / 4 + 0],
          i = Ce()[a / 4 + 1],
          o = Ce()[a / 4 + 2]
        if (o) throw xi(i)
        ...
        ;(O.__wbindgen_add_to_stack_pointer(16), (He[_r++] = void 0))
      }
    }
  }
...
function Us() {
  ...
  return (
    ...
    (n.wbg.__wbindgen_string_get = function (e, t) {
      ...
      var o = $s(i) ? 0 : mt(i, O.__wbindgen_malloc, O.__wbindgen_realloc),
        a = $e
    ...
    (n.wbg.__wbindgen_debug_string = function (e, t) {
      let r = yi(Se(t)),
        i = mt(r, O.__wbindgen_malloc, O.__wbindgen_realloc),
        o = $e
...
var Sn = class {
  ...
  async append_template_to_active_file(e) {
    ...
    if (!r || !r.file || !r.editor) {
      oe(new N("No active editor, can't append templates."))
      return
    }
    let { path: i } = r.file
  ...
  overwrite_active_file_commands() {
    let e = this.plugin.app.workspace.activeEditor
    if (!e || !e.file) {
      oe(new N("Active editor is null, can't overwrite content"))
      return
    }
  ...
  static async on_file_creation(e, t, r) {
    ...
    if (
      !(r.path.includes(i) && i !== '/') &&
      (await An(300), !e.files_with_pending_templates.has(r.path))
    )
    ...
    update_trigger_file_on_creation() {
      this.settings.trigger_on_file_creation
        ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on(
            'create',
            (e) => Sn.on_file_creation(this.templater, this.plugin.app, e),
          )),
  ...
  ;(n.defineMode('javascript', function (e, t) {
    ...
    function Tt(s, p) {
      ...
      if (s == 'variable' || h.style == 'keyword') {
        if (((h.marked = 'property'), p == 'get' || p == 'set')) return f(Bn)
        var A
        return (
          c &&
    ...
    function At(s, p) {
      ...
      if (c && p == '<') return f(B('>'), se(In, '>'), D, At)
    }
    function Ut(s, p) {
      if (p == '*') return ((h.marked = 'keyword'), f(Ut))
      if (s == 'variable') return (be(p), f(Ut))
      if (s == '(') return f(Re, B(')'), se(kt, ')'), D, Mi, xe)
      if (c && p == '<') return f(B('>'), se(In, '>'), D, Ut)
    }
    function qi(s, p) {
      if (s == 'keyword' || s == 'variable') return ((h.marked = 'type'), f(qi))
      if (p == '<') return f(B('>'), se(In, '>'), D)
    }
    function kt(s, p) {
      return (
        p == '@' && f(W, kt),
    ...
    function la(s, p) {
      return s == 'variable' ? Li(s, p) : qn(s, p)
    }
    function Li(s, p) {
      if (s == 'variable') return (be(p), f(qn))
    }
    function qn(s, p) {
      if (p == '<') return f(B('>'), se(In, '>'), D, qn)
      if (p == 'extends' || p == 'implements' || (c && s == ','))
        return (p == 'implements' && (h.marked = 'keyword'), f(c ? V : W, qn))
    ...
    function fa(s, p) {
      if (p == 'as') return ((h.marked = 'keyword'), f(Ln))
    }
    function Tr(s, p) {
