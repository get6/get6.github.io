...
![](assets/hevyplan-riverpod-course.png)
...
![](assets/riverpod-clean-architecture.png)
### feature
...
![](assets/riverpod-architecture-flow.png)
...
그리고 이번 글에는 코드는 작성하지 않았어요. 이렇게 글로 정리했지만 실제로 잘 다루는 건 아니라 저도 실제 프로젝트에서 적용해 보면서 해봐야 해서 적지 않았어요. 그럼 경험해 보고 올게요!
