...
- Keep side effects explicit and error handling visible.

## Validation
- Run available lint/tests for touched areas when feasible.
- If full validation is expensive, run the smallest meaningful subset and report it.

## Definition of Done
- [ ] Architecture boundaries respected
- [ ] State management responsibilities are separated
- [ ] Error handling is explicit for failure paths
